...
import {
  ...
  ChevronRight, ChevronLeft, Sparkles, ArrowRight, User, Mail, Phone
} from 'lucide-react';
...
export function DemoWizard() {
  ...
  const canProceed = () => {
    switch (step) {
      ...
      case 3: return Object.keys(tempLogs).length >= 2;
      case 4: return checkedItems.size >= 3;
      default: return true;
    }
  };
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          {step < 5 && (
            <div className="flex justify-between items-center mt-8 pt-6 border-t border-gray-100">
              ...
              <div className="flex items-center gap-3">
                <span className="text-sm text-gray-400">Step {step + 1} of 6</span>
