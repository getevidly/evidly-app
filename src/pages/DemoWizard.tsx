    ...
    <div className="min-h-screen bg-cream flex items-center justify-center py-8 px-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white rounded-xl border border-[#1E2D4D]/10 p-8">
          ...
          {step === 3 && (
            <div>
              ...
              <div className="space-y-5">
                ...
                <div className="border-t border-[#1E2D4D]/5 pt-5">
            ...
            <div>
              ...
              <div className="rounded-xl border border-[#1E2D4D]/10 overflow-hidden">
                ...
                {CHECKLIST_ITEMS.map((item, i) => (
                  <div key={i} onClick={() => { const next = new Set(checkedItems); if (next.has(i)) next.delete(i); else next.add(i); setCheckedItems(next); }} className={`flex items-center gap-3 px-4 py-3 border-b border-[#1E2D4D]/5 cursor-pointer transition-colors ${checkedItems.has(i) ? 'bg-green-50' : 'hover:bg-[#FAF7F0]'}`}>
          ...
          {step < 6 && (
            <div className="flex justify-between items-center mt-8 pt-6 border-t border-[#1E2D4D]/5">
              <button onClick={() => step > 0 ? setStep(step - 1) : navigate('/')} className="flex items-center gap-2 text-[#1E2D4D]/50 hover:text-[#1E2D4D]/80 transition-colors">
        ...
        {!showStaffLogin ? (
          <p className="text-center mt-6">
            <button
              ...
              className="text-xs text-[#1E2D4D]/30 hover:text-[#1E2D4D]/40 transition-colors"
            >
              Staff Login
            </button>
          </p>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm text-[#1E2D4D]/30 hover:text-[#1E2D4D]/70 transition-colors"
                >
                  Cancel
                </button>
              </div>
