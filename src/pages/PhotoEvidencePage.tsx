...
const LOCATIONS: LocationName[] = ['Location 1', 'Location 2', 'Location 3']; // demo
...
function CategoryBadge({ recordType, small = false }: { recordType: RecordType; small?: boolean }) {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 rounded-full font-semibold ${small ? 'px-1.5 py-0.5 text-[9px]' : 'px-2 py-0.5 text-xs'}`}
...
function createDemoPhotos(): GalleryPhoto[] {
  ...
  const defs: {
    ...
    { title: 'Walk-in Cooler', subtitle: '38°F Reading',
      recordType: 'Temperature Log', location: 'Location 1', // demo
    ...
    { title: 'Prep Table', subtitle: '41°F Surface Temp',
      recordType: 'Temperature Log', location: 'Location 2', // demo
    ...
    { title: 'Hot Hold Station', subtitle: '157°F Verified',
      recordType: 'Temperature Log', location: 'Location 3', // demo
    ...
    { title: 'Cleaning Completed', subtitle: 'End of Shift',
      recordType: 'Checklist', location: 'Location 1', // demo
    ...
    { title: 'Hand Wash Station', subtitle: 'Soap & Towels Stocked',
      recordType: 'Checklist', location: 'Location 2', // demo
    ...
    { title: 'Floor Drain', subtitle: 'Cleaned & Inspected',
      recordType: 'Checklist', location: 'Location 3', // demo
    ...
    { title: 'Grease Spill', subtitle: 'Kitchen Line Area',
      recordType: 'Incident', location: 'Location 1', // demo
    ...
    { title: 'Broken Tile', subtitle: 'Walk-in Entrance',
      recordType: 'Incident', location: 'Location 2', // demo
    ...
    { title: 'Receiving Inspection', subtitle: 'Produce Delivery',
      recordType: 'Vendor Delivery', location: 'Location 1', // demo
    ...
    { title: 'Receiving Inspection', subtitle: 'Meat & Poultry',
      recordType: 'Vendor Delivery', location: 'Location 3', // demo
    ...
    { title: 'Walk-in Cooler', subtitle: 'Door Seal Check',
      recordType: 'Equipment', location: 'Location 1', // demo
    ...
    { title: 'Fire Extinguisher', subtitle: 'Monthly Check',
      recordType: 'Equipment', location: 'Location 2', // demo
