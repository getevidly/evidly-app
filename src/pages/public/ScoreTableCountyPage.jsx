  ...
  <section style={{padding:"36px 24px",background:E.cream,borderTop:"1px solid "+E.g2}}>
    <div style={{maxWidth:780,margin:"0 auto"}}>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))",gap:14}}>
        {[
          {href:_cs?"/city/"+_cs:"/"+c.landingSlug,label:"EvidLY for "+(_cn||c.name+" County"),desc:"See where your "+(_cn?_cn+" ("+c.name+" County)":c.name+" County")+" operations align daily. Food safety + fire safety. Configured for "+c.agencyShort+".",cta:"Learn More →",color:E.navy},
          {href:"https://getevidly.com/operations-check?county="+encodeURIComponent(c.name)+"&source=scoretable",label:"Free Operations Check",desc:"11 questions. Every risk in dollars. See where your "+c.name+" County operation stands — 2 minutes, no account.",cta:"Get My Free Operations Check →",color:E.gold},
