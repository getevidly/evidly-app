  ...
  <section style={{padding:"36px 24px",background:E.cream,borderTop:"1px solid "+E.g2}}>
    <div style={{maxWidth:780,margin:"0 auto"}}>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))",gap:14}}>
        {[
          {href:_cs?"/city/"+_cs:"/"+c.landingSlug,label:"EvidLY for "+(_cn||c.name+" County"),desc:"Track your "+(_cn?_cn+" ("+c.name+" County)":c.name+" County")+" compliance score daily. Food safety + fire safety. Configured for "+c.agencyShort+".",cta:"Learn More →",color:E.navy},
