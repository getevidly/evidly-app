  ...
  */}
  ...
  <section style={{padding:"72px 24px 60px",background:heroGrad,textAlign:"center",position:"relative"}}>
    ...
    <div style={{maxWidth:700,margin:"0 auto"}}>
      ...
      <h1 style={{fontSize:"clamp(1.8rem,5vw,2.8rem)",fontWeight:800,lineHeight:1.1,margin:"0 0 16px",color:E.w}}>{_cn?<>{_cn} <span style={{color:E.gold}}>Kitchen Compliance</span></>:<>Answers before you ask.. <span style={{color:E.gold}}>Know Where You Stand.</span></>}</h1>
      ...
      <p style={{fontSize:"0.88rem",color:"rgba(255,255,255,0.4)",maxWidth:520,margin:"0 auto 28px",lineHeight:1.7}}>Food safety and fire safety. One clear picture. Updated every day.</p>
  ...
  <section id="what-covered" style={{padding:"72px 24px",background:E.w}}>
    <div style={{maxWidth:780,margin:"0 auto"}}>
      <div style={{textAlign:"center",marginBottom:32}}>
        <SL t="What's Covered"/>
        <h2 style={{fontSize:"clamp(1.3rem,4vw,2rem)",fontWeight:800,color:E.navy,margin:"0 0 8px"}}>Food safety and fire safety. One place.</h2>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(300px,1fr))",gap:20}}>
        <div style={{background:E.cream,borderRadius:16,padding:"32px 24px",border:"2px solid "+E.gold,position:"relative"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:7,textAlign:"left",maxWidth:280,margin:"0 auto 16px"}}>
            {["Scored against "+c.name+" County — not a generic checklist","Know where you stand before an inspector walks in","Every temp, checklist, and record in one place","Covers food safety and fire safety together","Your whole team, no extra cost","If it's not right in 45 days, you pay nothing"].map(function(f){return <div key={f} style={{display:"flex",gap:7,fontSize:"0.82rem",color:E.g6}}><span style={{color:E.gold,fontWeight:700}}>✓</span>{f}</div>;})}
          </div>
          <button onClick={function(){openM("signup");}} style={Object.assign({},bN,{padding:"12px 32px",fontSize:"0.9rem"})}>Reserve My Spot →</button>
          <p style={{marginTop:10,fontSize:"0.76rem",color:E.g4}}>Founder pricing available through August 7, 2026</p>
        </div>
  ...
  <section style={{padding:"64px 24px",background:heroGrad,textAlign:"center",position:"relative"}}>
    ...
    <h2 style={{fontSize:"clamp(1.4rem,4vw,2rem)",fontWeight:800,color:E.w,marginBottom:10}}>Answers before you ask.. Know Where You Stand.</h2>
  ...
  <footer style={{padding:"40px 24px 20px",background:"#2C3E5C"}}>
    <div style={{maxWidth:960,margin:"0 auto",display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1fr 1fr",gap:24}}>
      ...
      <div><h4 style={{fontSize:"0.7rem",fontWeight:700,color:"rgba(255,255,255,0.55)",marginBottom:8,textTransform:"uppercase",letterSpacing:1}}>Product</h4>{[{t:"Food Safety",h:"#"},{t:"Fire Safety",h:"#"},{t:"Kitchen Self Check",h:"/kitchen-check/"+c.slug},{t:"ScoreTable",h:"/scoretable/"+c.slug},{t:"Pricing",h:"#"}].map(function(l){return <a key={l.t} href={l.h} style={{display:"block",fontSize:"0.78rem",color:"rgba(255,255,255,0.5)",textDecoration:"none",marginBottom:6}}>{l.t}</a>;})}</div>
