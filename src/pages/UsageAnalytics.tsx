...
const MODULES: ModuleInfo[] = [
  ...
  { id: 'qr-passport', name: 'QR Passport', icon: '📱', color: '#B24A2E' },
...
<div style="font-size:28px;font-weight:800;color:white"><span style="color:#B24A2E">Evid</span>LY</div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px', flexWrap: 'wrap', gap: '16px' }}>
          ...
          <button
            ...
            style={{
              ...
              backgroundColor: '#B24A2E', color: 'white', fontWeight: 700,
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: '16px', marginTop: '16px', padding: '12px 16px', backgroundColor: '#f9fafb', borderRadius: '8px', ...F, flexWrap: 'wrap' }}>
          ...
          {[
            ...
            { label: 'Light', bg: '#fef3c7', color: '#B24A2E' },
                ...
                {([
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: emailSchedule === opt.id ? '2px solid #B24A2E' : '2px solid #e5e7eb',
