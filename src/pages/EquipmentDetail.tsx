...
const FIRE_TYPES = new Set([
  'Hood System', 'Fire Suppression System', 'Exhaust Fan', 'Elevator',
...
const DEMO_EQUIPMENT: EquipmentItem[] = [
  { id: 'EQ-001', name: 'Walk-in Cooler #1', type: 'Walk-in Cooler', make: 'True Manufacturing', model: 'TG2R-2S', serial: 'TM-2019-04821', locationId: '1', location: 'Location 1', installDate: '2019-01-15', purchasePrice: 9500, warrantyExpiry: '2024-01-15', warrantyProvider: 'True Manufacturing', warrantyTerms: '5-year parts and labor', warrantyContact: '1-800-878-3633', condition: 'Good', nextMaintenanceDue: '2026-02-28', maintenanceInterval: 'Quarterly', linkedVendor: 'HVAC Service Vendor', usefulLifeYears: 15, replacementCost: 11000, status: 'operational', notes: 'Replaced door gaskets Oct 2025. Running well.', serviceHistory: [{ date: '2025-10-12', vendor: 'HVAC Service Vendor', type: 'Door Gasket Replacement', cost: 450, notes: 'Replaced both door gaskets, checked refrigerant levels' }, { date: '2025-07-08', vendor: 'HVAC Service Vendor', type: 'Quarterly Maintenance', cost: 275, notes: 'Cleaned condenser coils, thermostat calibration' }], schedule: [{ task: 'Condenser coil cleaning', interval: 'Quarterly', lastDone: '2025-10-12', nextDue: '2026-01-12' }, { task: 'Thermostat calibration', interval: 'Semi-Annual', lastDone: '2025-07-08', nextDue: '2026-01-08' }] }, // demo
  { id: 'EQ-003', name: 'Hood Ventilation System', type: 'Hood System', make: 'Captive Aire', model: 'CK-48', serial: 'CA-2018-30982', locationId: '1', location: 'Location 1', installDate: '2018-08-20', purchasePrice: 18000, warrantyExpiry: '2023-08-20', warrantyProvider: 'Captive Aire', warrantyTerms: '5-year limited', condition: 'Fair', nextMaintenanceDue: '2026-01-20', maintenanceInterval: 'Quarterly', linkedVendor: 'Hood Cleaning Vendor', usefulLifeYears: 20, replacementCost: 22000, notes: 'Fan belt showing wear. Schedule replacement next service.', serviceHistory: [{ date: '2025-10-20', vendor: 'Hood Cleaning Vendor', type: 'Hood Cleaning', cost: 850, notes: 'Full hood and duct cleaning. Fan belt showing wear.' }, { date: '2025-07-20', vendor: 'Hood Cleaning Vendor', type: 'Hood Cleaning', cost: 850, notes: 'Quarterly deep clean. Grease buildup moderate.' }], schedule: [{ task: 'Hood & duct cleaning', interval: 'Quarterly', lastDone: '2025-10-20', nextDue: '2026-01-20' }, { task: 'Baffle filter replacement', interval: 'Annual', lastDone: '2025-04-18', nextDue: '2026-04-18' }] }, // demo
  { id: 'EQ-004', name: 'Fire Suppression System', type: 'Fire Suppression System', make: 'Ansul', model: 'R-102', serial: 'AN-2020-78543', locationId: '1', location: 'Location 1', installDate: '2020-11-05', purchasePrice: 6500, warrantyExpiry: '2026-11-05', warrantyProvider: 'Ansul / Tyco', warrantyTerms: '6-year system warranty', condition: 'Good', nextMaintenanceDue: '2026-05-05', maintenanceInterval: 'Semi-Annual', linkedVendor: 'Fire Suppression Vendor', usefulLifeYears: 12, replacementCost: 7500, notes: 'Semi-annual inspection by Fire Suppression Vendor. Under warranty.', serviceHistory: [{ date: '2025-11-05', vendor: 'Fire Suppression Vendor', type: 'Semi-Annual Inspection', cost: 0, notes: 'Warranty inspection. All nozzles clear, agent level OK.' }, { date: '2025-05-05', vendor: 'Fire Suppression Vendor', type: 'Semi-Annual Inspection', cost: 0, notes: 'System test passed. Links inspected.' }], schedule: [{ task: 'System inspection & test', interval: 'Semi-Annual', lastDone: '2025-11-05', nextDue: '2026-05-05' }] }, // demo
  { id: 'EQ-007', name: 'Commercial Dishwasher', type: 'Commercial Dishwasher', make: 'Hobart', model: 'AM15', serial: 'HB-2017-19843', locationId: '1', location: 'Location 1', installDate: '2017-09-01', purchasePrice: 12000, warrantyExpiry: '2022-09-01', warrantyProvider: 'Hobart', warrantyTerms: '5-year parts and labor', condition: 'Poor', nextMaintenanceDue: '2026-01-01', maintenanceInterval: 'Quarterly', linkedVendor: 'HVAC Service Vendor', usefulLifeYears: 8, replacementCost: 14500, status: 'needs_repair', notes: 'Past useful life. Frequent repairs. Replacement recommended.', serviceHistory: [{ date: '2025-12-18', vendor: 'HVAC Service Vendor', type: 'Emergency Repair', cost: 1200, notes: 'Replaced wash pump motor.' }, { date: '2025-10-01', vendor: 'HVAC Service Vendor', type: 'Quarterly Service', cost: 375, notes: 'Cleaned spray arms, descaled booster heater.' }], schedule: [{ task: 'Spray arm cleaning & descale', interval: 'Quarterly', lastDone: '2025-10-01', nextDue: '2026-01-01' }] }, // demo
  { id: 'EQ-009', name: 'Hood Ventilation System', type: 'Hood System', make: 'Captive Aire', model: 'CK-36', serial: 'CA-2020-41567', locationId: '2', location: 'Location 2', installDate: '2020-05-22', purchasePrice: 14000, warrantyExpiry: '2025-05-22', warrantyProvider: 'Captive Aire', warrantyTerms: '5-year limited', condition: 'Good', nextMaintenanceDue: '2026-02-22', maintenanceInterval: 'Quarterly', linkedVendor: 'Hood Cleaning Vendor', usefulLifeYears: 20, replacementCost: 18000, notes: 'Warranty recently expired. Good shape.', serviceHistory: [{ date: '2025-11-22', vendor: 'Hood Cleaning Vendor', type: 'Hood Cleaning', cost: 750, notes: 'Full cleaning. Good condition.' }], schedule: [{ task: 'Hood & duct cleaning', interval: 'Quarterly', lastDone: '2025-11-22', nextDue: '2026-02-22' }] }, // demo
  { id: 'EQ-017', name: 'Upblast Exhaust Fan — Main Hood', type: 'Exhaust Fan', make: 'Captive Aire', model: 'DU33HFA', serial: 'CA-2021-44812', locationId: '1', location: 'Location 1', installDate: '2021-03-15', purchasePrice: 3200, warrantyExpiry: '2026-03-15', warrantyProvider: 'Captive Aire', warrantyTerms: '5-year limited', condition: 'Good', nextMaintenanceDue: '2026-03-10', maintenanceInterval: 'Quarterly', linkedVendor: 'Hood Cleaning Vendor', usefulLifeYears: 15, replacementCost: 3800, notes: 'Cleaned with main hood system. Belt replaced Oct 2025.', serviceHistory: [{ date: '2025-12-10', vendor: 'Hood Cleaning Vendor', type: 'Quarterly Cleaning', cost: 0, notes: 'Fan blades cleaned, hinge kit lubricated.' }], schedule: [{ task: 'Clean blades & housing', interval: 'Quarterly', lastDone: '2025-12-10', nextDue: '2026-03-10' }] }, // demo
];
