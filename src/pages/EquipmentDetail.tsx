...
const DEMO_EQUIPMENT: EquipmentItem[] = [
  ...
  { id: 'EQ-003', name: 'Hood Ventilation System', type: 'Hood System', make: 'Captive Aire', model: 'CK-48', serial: 'CA-2018-30982', locationId: '1', location: 'Location 1', installDate: '2018-08-20', purchasePrice: 18000, warrantyExpiry: '2023-08-20', warrantyProvider: 'Captive Aire', warrantyTerms: '5-year limited', condition: 'Fair', nextMaintenanceDue: '2026-01-20', maintenanceInterval: 'Quarterly', linkedVendor: 'ABC Fire Protection', usefulLifeYears: 20, replacementCost: 22000, notes: 'Fan belt showing wear. Schedule replacement next service.', serviceHistory: [{ date: '2025-10-20', vendor: 'ABC Fire Protection', type: 'Hood Cleaning', cost: 850, notes: 'Full hood and duct cleaning. Fan belt showing wear.' }, { date: '2025-07-20', vendor: 'ABC Fire Protection', type: 'Hood Cleaning', cost: 850, notes: 'Quarterly deep clean. Grease buildup moderate.' }], schedule: [{ task: 'Hood & duct cleaning', interval: 'Quarterly', lastDone: '2025-10-20', nextDue: '2026-01-20' }, { task: 'Baffle filter replacement', interval: 'Annual', lastDone: '2025-04-18', nextDue: '2026-04-18' }] }, // demo
