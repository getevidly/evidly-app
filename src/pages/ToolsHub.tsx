/**
 * ToolsHub — Category landing page for Tools.
 *
 * Dynamically builds cards from the current role's tools
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        >
          Calendar, inspector arrival mode, kitchen checkup, self-diagnosis, and more.
        </p>
      </div>
      ...
      {items.length > 0 ? (
        ...
        >
          ...
          <p className="text-sm font-medium" style={{ color: 'var(--text-secondary, #3D5068)' }}>
            No tools are assigned to your role.
          </p>
        </div>
      )}
    </div>
