...
const DEMO_EMPLOYEES = [
  { id: '1', name: 'Marcus Johnson', role: 'Admin', appRole: 'owner_operator', locationId: '1', locationName: 'Location 1', hireDate: '2024-01-15', certs: [ // demo
  ...
  { id: '2', name: 'Sarah Chen', role: 'Manager', appRole: 'kitchen_manager', locationId: '1', locationName: 'Location 1', hireDate: '2024-03-01', certs: [ // demo
  ...
  { id: '3', name: 'Maria Garcia', role: 'Manager', appRole: 'kitchen_manager', locationId: '2', locationName: 'Location 2', hireDate: '2024-06-10', certs: [ // demo
  ...
  { id: '4', name: 'David Park', role: 'Staff', appRole: 'kitchen_staff', locationId: '2', locationName: 'Location 2', hireDate: '2024-04-02', certs: [ // demo
  ...
  { id: '5', name: 'Michael Torres', role: 'Staff', appRole: 'kitchen_staff', locationId: '2', locationName: 'Location 2', hireDate: '2023-02-26', certs: [ // demo
  ...
  { id: '6', name: 'Emma Rodriguez', role: 'Staff', appRole: 'kitchen_staff', locationId: '1', locationName: 'Location 1', hireDate: '2025-07-10', certs: [ // demo
  ...
  { id: '7', name: 'Alex Thompson', role: 'Staff', appRole: 'kitchen_staff', locationId: '3', locationName: 'Location 3', hireDate: '2024-12-10', certs: [ // demo
  ...
  { id: '8', name: 'Lisa Wang', role: 'Staff', appRole: 'kitchen_staff', locationId: '3', locationName: 'Location 3', hireDate: '2025-01-25', certs: [ // demo
  ...
  { id: '9', name: 'Maria Rodriguez', role: 'Staff', appRole: 'kitchen_staff', locationId: '3', locationName: 'Location 3', hireDate: '2025-02-05', certs: [ // demo
