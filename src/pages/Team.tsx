...
const DEMO_MEMBERS: TeamMember[] = [
  ...
  },
  {
    ...
    location: 'Location 1', training_completed: 10, training_total: 10, temp_logs_completed: 142, checklists_completed: 68, compliance_score: 95, // demo
    certifications: [
  ...
  },
  {
    ...
    location: 'Location 2', training_completed: 9, training_total: 10, temp_logs_completed: 128, checklists_completed: 72, compliance_score: 88, // demo
    certifications: [
  ...
  },
  {
    ...
    location: 'Location 3', training_completed: 6, training_total: 8, temp_logs_completed: 64, checklists_completed: 38, compliance_score: 72, // demo
    certifications: [
  ...
  },
  {
    ...
    location: 'Location 2', training_completed: 7, training_total: 8, temp_logs_completed: 96, checklists_completed: 45, compliance_score: 82, // demo
    certifications: [
  ...
  },
  {
    ...
    location: 'Location 1', training_completed: 8, training_total: 8, temp_logs_completed: 72, checklists_completed: 52, compliance_score: 94, // demo
    certifications: [
  ...
  },
  {
    ...
    location: 'Location 1', training_completed: 7, training_total: 8, temp_logs_completed: 88, checklists_completed: 41, compliance_score: 90, // demo
    certifications: [
  ...
  },
  {
    ...
    location: 'Location 2', training_completed: 5, training_total: 8, temp_logs_completed: 34, checklists_completed: 22, compliance_score: 76, // demo
    certifications: [
  ...
  },
  {
    ...
    location: 'Location 3', training_completed: 3, training_total: 8, temp_logs_completed: 18, checklists_completed: 12, compliance_score: 65, // demo
    certifications: [
