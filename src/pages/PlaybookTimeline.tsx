...
export function PlaybookTimeline() {
  ...
  if (!incident || !template) {
    return (
      <div style={{ ...font, padding: 40, textAlign: 'center' }}>
        <AlertTriangle size={48} color="#B24A2E" style={{ marginBottom: 16 }} />
  ...
  return (
    <div style={{ ...font, maxWidth: 960, margin: '0 auto', padding: '16px 12px 64px' }}>
      ...
      <div style={{
        ...
        borderTop: `4px solid #B24A2E`, padding: '16px 16px', marginBottom: 28,
      }}>
        <h3 style={{ fontSize: 17, fontWeight: 700, color: '#1E2D4D', margin: '0 0 16px', display: 'flex', alignItems: 'center', gap: 8 }}>
          <Thermometer size={18} color="#B24A2E" /> Food Disposition Summary
        </h3>
      ...
      <div style={{
        ...
        <h3 style={{ fontSize: 17, fontWeight: 700, color: '#1E2D4D', margin: '0 0 16px', display: 'flex', alignItems: 'center', gap: 8 }}>
          <DollarSign size={18} color="#B24A2E" /> Insurance Claim
        </h3>
        {(() => {
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...font, display: 'inline-flex', alignItems: 'center', gap: 6, background: '#B24A2E',
            color: '#fff', border: 'none', borderRadius: 8, padding: '10px 20px',
            fontSize: 14, fontWeight: 600, cursor: 'pointer', minHeight: 44,
          }}
        >
      ...
      <div style={{ marginBottom: 36 }}>
        <button
          ...
          style={{
            ...font, display: 'inline-flex', alignItems: 'center', gap: 8, background: '#B24A2E',
      ...
      <div style={{
        ...
        <div style={{ fontSize: 14, color: 'var(--text-secondary, #3D5068)', lineHeight: 1.7 }}>
          ...
          <p style={{ margin: 0, fontSize: 12, color: 'var(--text-secondary, #3D5068)', fontStyle: 'italic' }}>
            Auto-generated by EvidLY &mdash; {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
          </p>
        </div>
      </div>
    </div>
