          ...
          <div style={{ padding: '16px 16px' }}>
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 20, flexWrap: 'wrap' }}>
              ...
              <button
                ...
                style={{ padding: '10px 20px', borderRadius: 8, border: '1px solid #B24A2E', background: '#fffbeb', color: '#92400e', fontSize: 13, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6, minHeight: 44, fontFamily: "'DM Sans', sans-serif" }}
              >
