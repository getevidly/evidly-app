...
function PricingPreview({ numLocations }) {
  ...
  return (
    <div className="bg-[#FAF7F0] border border-[#A08C5A]/20 rounded-xl p-4 mt-4">
      ...
      <p className="text-2xl font-bold text-[#1E2D4D]">
...
export default function DemoTours() {
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold text-[#1E2D4D] mb-1">Demo Tours</h1>
      ...
      {activeTab === 'active' && (
        <div className="space-y-4">
          {loading && <p className="text-gray-400 text-sm">Loading tours...</p>}
          ...
          {createdTour ? (
            ...
            <div className="space-y-6">
              ...
              <fieldset className="space-y-3">
                ...
                <label className="block">
                  <span className="text-xs text-gray-500">Industry Type</span>
              ...
              <fieldset className="space-y-3">
                ...
                <label className="block">
                  <span className="text-xs text-gray-500">Number of Locations</span>
              ...
              <fieldset className="space-y-3">
                ...
                <label className="block">
                  <span className="text-xs text-gray-500">Schedule For (optional)</span>
      ...
      {activeTab === 'templates' && (
        <div className="grid grid-cols-2 gap-4">
          {templates.map(t => (
            <div key={t.id}
              className="bg-white border border-gray-200 rounded-xl p-5 hover:border-[#A08C5A]/40 transition-colors">
      ...
      {activeTab === 'completed' && (
        <div className="space-y-4">
          {completedTours.length === 0 && (
            <p className="text-center text-gray-400 py-8">No completed tours yet.</p>
          )}
