  ...
  if (error) {
    return (
      <div className="p-8 text-center">
        ...
        <button onClick={loadUsers} className="mt-4 px-4 py-2.5 bg-[#1E2D4D] text-white rounded-lg text-sm font-medium hover:bg-[#162340] transition-colors min-h-[44px]">Retry</button>
      </div>
    );
  }
