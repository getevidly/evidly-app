  ...
  return (
    <div className="min-h-screen" style={{ background: '#F4F6FA' }}>
      ...
      <div style={{ background: '#1E2D4D' }} className="px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-gray-400">· Partner Dashboard</span>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-6">
        ...
        {loading ? (
          <div className="text-center py-16 text-gray-400 text-sm">Loading partner data...</div>
        ) : (
          <>
            {/* ── STATUS TAB ─────────────────────────────────── */}
            {activeTab === 'status' && (
              <div className="space-y-6">
                {partnerProfile ? (
                  <div className="rounded-xl p-6" style={{ background: '#1E2D4D' }}>
                    ...
                    <div className="text-white text-lg font-semibold mt-3">{partnerProfile.company_name}</div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-white rounded-xl border border-gray-200 p-4 text-center">
                    <div className="text-2xl font-bold" style={{ color: '#1E2D4D' }}>
                      {leads.filter(l => l.status === 'new').length}
                    </div>
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 p-4 text-center">
                    <div className="text-2xl font-bold" style={{ color: partnerProfile?.performance_score >= 90 ? '#16a34a' : '#d97706' }}>
                  ...
                  leads.map(lead => {
                    ...
                    return (
                      <div key={lead.id} className="bg-white rounded-xl border border-gray-200 p-4">
                        ...
                        {lead.notes && (
                          <p className="text-xs text-gray-500 mb-3">{lead.notes}</p>
                        )}
                        <div className="flex items-center gap-2">
                          ...
                          {lead.operator_phone && (
                            <a href={`tel:${lead.operator_phone}`} className="p-1.5 border border-gray-200 rounded-lg hover:bg-gray-50">
