...
const DEMO_PAST_CONVERSATIONS: Conversation[] = [ // demo
  {
    id: 'past-1', title: 'Location 2 score drop analysis', mode: 'chat', createdAt: Date.now() - 86400000 * 2, // demo
    messages: [
      { id: 'p1-1', role: 'user', content: 'Why did my compliance score drop at Location 2?', timestamp: Date.now() - 86400000 * 2 }, // demo
      { id: 'p1-2', role: 'assistant', content: 'Your compliance score at **Location 2** dropped from **94%** to **87%** over the past 7 days due to 3 missed temperature logs and an expired hood cleaning certificate. The food safety pillar dropped 5 points and facility safety dropped 2 points.', timestamp: Date.now() - 86400000 * 2 + 5000, suggestions: ['Show me the details', 'How to fix it?'] }, // demo
    ],
  },
  {
  ...
  {
    id: 'past-3', title: 'Mock inspection — Location 1', mode: 'inspection', createdAt: Date.now() - 86400000 * 7, // demo
    messages: [
      { id: 'p3-1', role: 'assistant', content: 'Starting mock Health Department inspection for Location 1. Question 1: What is the current temperature of your walk-in cooler?', timestamp: Date.now() - 86400000 * 7 }, // demo
