...
const FAQ_CATEGORIES: FaqCategory[] = [
  ...
  { id: 'compliance', name: 'Compliance & Inspections', icon: '🛡️', articles: [
    { id: 'co-1', title: 'How your compliance score is calculated', views: 2156, helpful: 95, body: 'Your score is a weighted average of three categories: Operational (temp logs, checklists), Equipment (maintenance, calibration), and Documentation (permits, training records). Weights vary by industry.' },
