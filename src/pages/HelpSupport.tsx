...
const FAQ_CATEGORIES: FaqCategory[] = [
  ...
  { id: 'temp-readings', name: 'Temperature Readings', icon: '\u{1F321}️', articles: [
    ...
    { id: 'tr-4', title: 'Cooling Logs', views: 987, helpful: 91, body: `Cooling is one of the most critical food safety steps. The current CalCode standard requires food to cool from 135°F to 70°F within 2 hours, then from 70°F to 41°F within 4 additional hours (6 hours total). CalCode §114002(b) and FDA Food Code §3-501.14 are identical on these thresholds — the clock starts when food first drops below 135°F. EvidLY tracks both stages automatically. When you start a cooling log, enter the food item and starting temperature. EvidLY will prompt you at timed intervals to record progress and will alert you if the cooling rate is too slow.` },
  ...
  // ── Category 4: Fire Safety ──
  { id: 'facility-safety', name: 'Fire Safety', icon: '\u{1F525}', articles: [
    { id: 'fs-1', title: 'Fire Safety Overview', views: 1198, helpful: 92, body: `Fire Safety is EvidLY’s second pillar, covering everything related to the physical building and equipment — hood cleaning, fire suppression systems, fire extinguishers, pest control, grease traps, elevators, and backflow prevention. These are the seven vendor service categories EvidLY tracks. Go to Fire Safety to see your fire safety checklist, equipment status, and vendor service schedules. Keeping these current is critical — fire code violations can shut a kitchen down faster than food safety violations.` },
  ...
  { id: 'billing', name: 'Account & Billing', icon: '\u{1F4B3}', articles: [
    { id: 'ab-1', title: 'Subscription Plans', views: 1543, helpful: 89, body: `EvidLY offers three tiers: Founder Plan ($99/month base + $49 per location for 1-10 locations), Standard Plan ($199/month base + $99 per location), and Enterprise (custom pricing for 11+ locations). The Founder Plan includes early adopter benefits and is available to the first 1,000 customers. Annual billing gives you 2 months free (pay for 10 months, get 12). All plans include full access to both Food Safety and Fire safety categorys, the Jurisdiction Intelligence Engine, and all compliance features.` },
