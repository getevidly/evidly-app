  ...
  if (!isDemoMode) {
    return (
      <div className="p-6" style={F}>
        <button onClick={() => navigate('/sensors')} className="flex items-center gap-1 text-sm text-[#1E2D4D]/50 hover:text-gray-700 mb-4">
    ...
    <div className="px-3 sm:px-6 py-6 max-w-[1200px] mx-auto" style={F}>
      ...
      <div className="flex items-start justify-between flex-wrap gap-3 mb-6">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button onClick={() => guardAction('edit', 'IoT Sensors', () => toast.info('Edit thresholds — demo mode'))} className="flex items-center gap-1.5 px-3 py-2 rounded-lg border border-[#1E2D4D]/10 text-xs font-medium text-[#1E2D4D]/70 hover:bg-gray-50 min-h-[44px]">
            <Settings className="h-3.5 w-3.5" /> Thresholds
          </button>
          <button onClick={() => guardAction('edit', 'IoT Alerts', () => toast.info('Edit alerts — demo mode'))} className="flex items-center gap-1.5 px-3 py-2 rounded-lg border border-[#1E2D4D]/10 text-xs font-medium text-[#1E2D4D]/70 hover:bg-gray-50">
            <Bell className="h-3.5 w-3.5" /> Alerts
          </button>
          <button onClick={() => guardAction('edit', 'IoT Sensors', () => toast.info('Reassign zone — demo mode'))} className="flex items-center gap-1.5 px-3 py-2 rounded-lg border border-[#1E2D4D]/10 text-xs font-medium text-[#1E2D4D]/70 hover:bg-gray-50">
