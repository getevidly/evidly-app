  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto py-8 px-4">
        <h1 className="text-2xl font-bold text-[#1E2D4D] mb-2">Privacy Policy</h1>
        <p className="text-sm text-gray-600 mb-8">Last updated: February 14, 2026</p>

        <div className="prose prose-sm max-w-none text-gray-700 space-y-6">
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">3. Data Storage and Security</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">4. Data Sharing</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">5. Your Rights</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">6. Cookies and Analytics</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">7. California Privacy Rights (CCPA)</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">8. Children's Privacy</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">9. Changes to This Policy</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">10. Contact Us</h2>
