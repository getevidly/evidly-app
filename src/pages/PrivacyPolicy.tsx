  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto py-8 px-4">
        <h1 className="text-2xl font-bold tracking-tight text-[#1E2D4D] mb-2">Privacy Policy</h1>
        <p className="text-sm text-[#1E2D4D]/70 mb-8">Last updated: February 14, 2026</p>
        ...
        <div className="prose prose-sm max-w-none text-[#1E2D4D]/80 space-y-6">
          ...
          <section>
            <h2 className="text-lg font-semibold tracking-tight text-[#1E2D4D]">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold tracking-tight text-[#1E2D4D]">3. Data Storage and Security</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold tracking-tight text-[#1E2D4D]">5. Your Rights</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold tracking-tight text-[#1E2D4D]">7. California Privacy Rights (CCPA)</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold tracking-tight text-[#1E2D4D]">8. Children's Privacy</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold tracking-tight text-[#1E2D4D]">10. Contact Us</h2>
