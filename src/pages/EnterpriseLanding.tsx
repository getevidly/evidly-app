    ...
    <div className="min-h-screen" style={{ background: 'linear-gradient(180deg, #eef4f8 0%, #ffffff 50%)', ...F }}>
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-14">
          ...
          <h1 className="text-3xl font-bold text-[#1E2D4D] mb-3">White-Label Compliance for Global Organizations</h1>
        ...
        {/* Pricing */}
        <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-5 mb-8 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          {[
            ...
            <div key={item.label} className="bg-white rounded-xl border border-gray-200 p-6 text-center">
              <p className="text-2xl font-bold" style={{ color: '#1E2D4D' }}>{item.value}</p>
