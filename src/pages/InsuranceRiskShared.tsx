...
const DEMO_RISK_DATA = {
  ...
  factors: [
    { name: 'Fire Risk', icon: Flame, color: '#ef4444', score: 95, weight: '40%', grade: 'A', detail: 'All fire safety systems current per NFPA 96 (2025 Edition). 0 overdue services.', dataPoints: 847 },
