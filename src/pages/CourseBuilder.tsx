            ...
            <div style={{ display: 'grid', gap: 20 }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  {['#15803d', '#1E2D4D', '#dc2626', '#7c3aed', '#B24A2E', '#0369a1'].map(c => (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                ...
                <button onClick={() => toast.info('AI Generate Questions (Demo)')}
                  style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '10px 16px', borderRadius: 8, border: '1px solid #B24A2E', background: '#fffbeb', color: '#92400e', fontSize: 14, fontWeight: 600, cursor: 'pointer', fontFamily: "'DM Sans', sans-serif", minHeight: 48 }}>
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {['loc-downtown', 'loc-airport', 'loc-university'].map(locId => { // demo
                  const names: Record<string, string> = { 'loc-downtown': 'Location 1', 'loc-airport': 'Location 2', 'loc-university': 'Location 3' }; // demo
                  return (
