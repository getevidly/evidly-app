...
function ToggleSwitch({ checked, onChange }: { checked: boolean; onChange: (v: boolean) => void }) {
  return (
    <button
      ...
      className={`w-[44px] h-6 rounded-xl border-none relative cursor-pointer shrink-0 transition-colors duration-200 ${checked ? 'bg-navy-muted' : 'bg-gray-300'}`}
    >
      <div
    ...
    <div className="bg-[#F4F6FA] min-h-screen p-6" style={{ ...FONT }}>
      ...
      <div className="mb-6">
        <button
          ...
          className="flex items-center gap-1.5 bg-transparent border-none text-navy-mid text-[13px] font-medium cursor-pointer p-0 mb-3"
        >
          <ArrowLeft size={16} />
          Back to Settings
        </button>
        <h1 className="text-2xl font-bold text-navy-muted m-0">
          Clock & Attendance Settings
        </h1>
        <p className="text-sm text-navy-mid mt-1.5 mb-0">
      ...
      <div className={cardClasses}>
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-navy-deeper m-0">
                Clock-In Reminders
              </h2>
              <p className="text-[13px] text-navy-mid mt-1 mb-0">
        ...
        {clockInEnabled && (
          <div className="pl-[30px]">
            <label className="block text-[13px] font-semibold text-navy-deeper mb-2">
            ...
            <div className="flex items-center gap-4">
              <input
                ...
                className="flex-1 cursor-pointer accent-navy-muted"
              />
              <input
                type="number"
                min="5"
                ...
                value={clockInMinutes}
                onChange={(e) => setClockInMinutes(Number(e.target.value))}
                className="w-20 px-3 py-2 rounded-lg border border-border_ui-cool text-sm text-center font-semibold text-navy-deeper"
              />
              <span className="text-[13px] text-navy-mid min-w-[60px]">minutes</span>
            </div>
            <p className="text-xs text-slate_ui mt-2 mb-0">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <input
                  ...
                  className="w-20 px-3 py-2 rounded-lg border border-border_ui-cool text-sm text-center font-semibold text-navy-deeper"
                />
                <span className="text-[13px] text-navy-mid min-w-[60px]">meters</span>
              </div>
              <p className="text-xs text-slate_ui mt-2 mb-0">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-6 mb-4">
              ...
              <div className="text-center shrink-0">
                <div
                  className="w-[120px] h-[120px] rounded-full border-[3px] border-dashed border-navy-muted flex items-center justify-center relative mx-auto mb-2"
                  style={{ background: `linear-gradient(135deg, ${NAVY}08 0%, ${NAVY}15 100%)` }}
                >
                  <div className="w-3 h-3 rounded-full bg-navy-muted shadow-[0_0_0_4px_rgba(22,58,95,0.2)]" />
                </div>
                <div className="text-lg font-bold text-navy-muted">
                  {geofenceRadius}m
                </div>
              ...
              {/* Explanation */}
              <div className="flex-1">
                <p className="text-[13px] text-navy-deeper leading-relaxed mb-3 mt-0">
                ...
                <div className="bg-[#EEF1F7] rounded-lg p-3 border border-border_ui-cool">
                  <p className="text-xs text-navy-mid m-0 leading-normal">
      ...
      <div className="flex justify-end">
        <button
          onClick={handleSave}
          disabled={saving}
          className={`flex items-center gap-2 py-3 px-7 rounded-lg border-none bg-navy-muted text-white text-sm font-semibold shadow-[0_2px_4px_rgba(22,58,95,0.15)] ${saving ? 'cursor-not-allowed opacity-70' : 'cursor-pointer opacity-100'}`}
        >
