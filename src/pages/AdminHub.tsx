/**
 * AdminHub — Category landing page for Administration.
 *
 * Dynamically builds cards from the current role's administration
...
export function AdminHub() {
  ...
  const section = config.sections.find(s => s.id === 'administration');
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        >
          Team management, settings, equipment, locations, role permissions, and training records.
        </p>
      </div>
      ...
      {items.length > 0 ? (
        ...
        >
          ...
          <p className="text-sm font-medium" style={{ color: 'var(--text-secondary, #3D5068)' }}>
            No administration tools are assigned to your role.
          </p>
        </div>
      )}
    </div>
