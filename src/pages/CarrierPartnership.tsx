        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              { icon: Flame, title: 'Fire Safety Verification', desc: 'NFPA 96/17A/10/72 compliance status with service dates and vendor documentation' },
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 mb-8">
          ...
          <div className="space-y-2">
            {[
              ...
              { method: 'GET', path: '/api/v1/risk-score/{id}/fire-safety', desc: 'NFPA compliance' },
