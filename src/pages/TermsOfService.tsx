  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto py-8 px-4">
        <h1 className="text-2xl font-bold text-[#1E2D4D] mb-2">Terms of Service</h1>
        <p className="text-sm text-gray-600 mb-8">Last updated: February 14, 2026</p>

        <div className="prose prose-sm max-w-none text-gray-700 space-y-6">
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">3. User Accounts</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">4. Subscription and Billing</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">5. Data Ownership</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">6. Privacy</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">7. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">8. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">9. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">10. Termination</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">11. Governing Law</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1E2D4D]">12. Contact Information</h2>
