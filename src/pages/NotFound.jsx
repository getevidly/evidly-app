      ...
      <div className="text-center max-w-md">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-[#1E2D4D] mb-6">
            <span className="text-3xl font-bold tracking-tight text-white tracking-tight">E</span>
          </div>
        </div>
        ...
        <p className="text-[#1E2D4D]/50 text-sm leading-relaxed mb-8">
        ...
        <button
          ...
          className="mt-6 inline-flex items-center gap-1.5 text-sm text-[#1E2D4D]/50 hover:text-[#1E2D4D] transition-colors"
        >
