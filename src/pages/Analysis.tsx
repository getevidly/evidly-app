...
const DEMO_ALERTS: PredictiveAlert[] = [
  ...
  },
  {
    ...
    severity: 'high',
    title: 'Walk-in Cooler Temp Trending Up — Location 3', // demo
  ...
  },
  {
    ...
    severity: 'high',
    title: 'Health Permit Expires in 14 Days — Location 1', // demo
  ...
  },
  {
    ...
    severity: 'high',
    title: 'Fire Suppression Inspection Overdue — Location 3', // demo
  ...
  },
  {
    ...
    alert_type: 'inspection_due',
    severity: 'medium',
    title: 'Fire Extinguisher Inspection Due in 21 Days — Location 2', // demo
  ...
  },
  {
    ...
    description: 'Emma Davis food handler certification expires on March 11. She works the morning shift at Location 2.', // demo
  ...
  },
  {
    ...
    severity: 'medium',
    title: 'Checklist Completion Dropped 12% — Location 3', // demo
  ...
  },
  {
    ...
    severity: 'medium',
    title: 'Grease Trap Service 5 Days Overdue — Location 1', // demo
  ...
  },
  {
    ...
    alert_type: 'service_overdue',
    severity: 'low',
    title: 'HVAC Filter Replacement Due in 45 Days — Location 2', // demo
  ...
  },
  {
    ...
    alert_type: 'document_expiring',
    severity: 'low',
    title: 'Business License Renewal Due in 60 Days — Location 1', // demo
  ...
  },
  {
    ...
    alert_type: 'temp_trending',
    severity: 'low',
    title: 'Freezer Temp Variance Increasing — Location 1', // demo
  ...
  },
  {
    ...
    alert_type: 'temp_trending',
    severity: 'high',
    title: 'Walk-in Door Seal Replaced — Location 1', // demo
  ...
  },
  {
    ...
    alert_type: 'service_overdue',
    severity: 'medium',
    title: 'Thermometer #3 Replaced — Location 2', // demo
