...
export default function VendorDemoDashboard() {
  ...
  return (
    <div>
      ...
      {loading && <p className="text-gray-400 text-sm">Loading vendor demo...</p>}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            ...
            <div className="space-y-3">
              ...
              {clients.length === 0 && (
                <p className="text-sm text-gray-400">No client data generated yet.</p>
              )}
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <h2 className="text-lg font-semibold text-[#1E2D4D] mb-4">Vendor Connect Status</h2>
                ...
                <div key={client.id || i} className="flex items-center justify-between p-3 bg-[#FAF7F0] rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Hood Cleaning — NFPA 96</p>
                    </div>
                  </div>
          ...
          <div className="bg-[#FAF7F0] border border-[#A08C5A]/20 rounded-xl p-6">
            <h2 className="text-lg font-semibold text-[#1E2D4D] mb-2">Lead Pipeline</h2>
            <p className="text-sm text-gray-500 mb-4">
              Simulated Day 30 outreach — restaurants in your service area who need hood cleaning
            </p>
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <p className="text-2xl font-bold text-[#1E2D4D]">12</p>
                <p className="text-xs text-gray-500">Overdue Locations</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-[#A08C5A]">5</p>
                <p className="text-xs text-gray-500">In Your Counties</p>
              </div>
              <div>
