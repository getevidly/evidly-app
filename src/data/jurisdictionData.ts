...
export const JURISDICTION_DATABASE: JurisdictionScore[] = [
  ...
  {
    id: 'nps_yosemite_food',
    agencyName: 'National Park Service — Yosemite Environmental Health',
    county: 'Mariposa', state: 'CA', pillar: 'food_safety',
    gradingScale: 'FDA Food Code Compliance / Non-Compliance',
    passingThreshold: 'No Priority Foundation or Priority violations uncorrected',
    inspectionFrequency: '2–4× per year (federal schedule)',
    transparencyLevel: 'medium',
    transparencyNotes: 'NPS conducts independent federal food safety inspections under FDA Food Code (not CalCode). Results reported through NPS Public Health Program — not published to county portal.',
