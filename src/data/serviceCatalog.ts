...
export const CPP_SERVICES: ServiceLine[] = [
  ...
  // ──────────────────────────────────────────────────────
  {
    ...
    shortDescription: 'NFPA 96 Table 12.4 compliant exhaust system cleaning with IKECA-certified documentation',
    fullDescription: `Complete cleaning of hood filters, plenum, ducts, and fans per NFPA 96 Table 12.4 frequency schedules. Includes before/after photography, grease weight documentation, IKECA-certified service certificate, and automatic upload to your EvidLY facility safety record.`,
    nfpaReference: 'NFPA 96 Table 12.4',
    additionalRegs: [
      'NFPA 96 Chapter 11 — Procedures for the Use of the System',
      'California Fire Code §904.12',
      'CalCode §114149.1',
    ],
    frequency: 'Monthly, Quarterly, Semi-Annual, or Annual — per NFPA 96 Table 12.4 based on cooking type and volume',
    ...
    costDrivers: [
      ...
      },
      {
        ...
        helpText: 'Determines required cleaning frequency per NFPA 96 Table 12.4',
      },
      {
        id: 'property_value',
    ...
    riskCalculations: [
      ...
      },
      {
        ...
        regulatoryBasis: 'NFPA 96 Table 12.4 — standard insurer compliance requirement',
        probability: 'High',
      ...
      },
      {
        ...
        regulatoryBasis: 'NFPA 96 — grease accumulation as primary commercial kitchen fire cause',
        probability: 'Medium',
  ...
  // ──────────────────────────────────────────────────────
  {
    ...
    nfpaReference: 'NFPA 96 Chapter 11 — Air Movement. Verify specific section requirements with your AHJ.',
    additionalRegs: [
      'NFPA 96 Chapter 11 — Air Movement (fan maintenance). Verify specific section requirements with your AHJ.',
      'NFPA 96 Chapter 11 — Air Movement (airflow performance). Verify specific section requirements with your AHJ.',
    ],
    ...
    riskCalculations: [
      {
        ...
        regulatoryBasis: 'NFPA 96 Chapter 11 — kitchen cannot operate without compliant exhaust system. Verify specific section requirements with your AHJ.',
        probability: 'High',
      ...
      },
      {
        ...
        regulatoryBasis: 'NFPA 96 Chapter 11 — fan maintenance requirement. Verify specific section requirements with your AHJ.',
        probability: 'High',
      ...
      },
      {
        ...
        regulatoryBasis: 'NFPA 96 Table 12.4 — cleaning frequency tied to system performance',
        probability: 'High',
        calculate: (i) => ({
      ...
      },
      {
        ...
        regulatoryBasis: 'NFPA 96 Chapter 11 — airflow performance as facility safety requirement. Verify specific section requirements with your AHJ.',
        probability: 'Medium',
        calculate: (i) => ({
  ...
  // ──────────────────────────────────────────────────────
  {
    ...
    nfpaReference: 'NFPA 96 Chapter 9 — Grease Removal Devices. Verify specific section requirements with your AHJ.',
    additionalRegs: [
      'NFPA 96 Chapter 9 — Grease Removal Devices (filter condition). Verify specific section requirements with your AHJ.',
    ...
    riskCalculations: [
      ...
      },
      {
        ...
        regulatoryBasis: 'NFPA 96 Chapter 9 — filter performance directly affects duct grease accumulation rate. Verify specific section requirements with your AHJ.',
        probability: 'High',
  ...
  // ──────────────────────────────────────────────────────
  {
    ...
    nfpaReference: 'NFPA 96 Chapter 11 — Air Movement (grease collection and disposal). Verify specific section requirements with your AHJ.',
    additionalRegs: [
      'NFPA 96 Chapter 11 — Air Movement (exhaust system rooftop). Verify specific section requirements with your AHJ.',
