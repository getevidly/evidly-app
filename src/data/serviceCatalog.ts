...
export const CPP_SERVICES: ServiceLine[] = [
  ...
  // ──────────────────────────────────────────────────────
  {
    ...
    nfpaReference: 'NFPA 96 (2024) §11.6 — Inspection of Exhaust System',
    additionalRegs: [
      'NFPA 96 (2024) §11.4 — Maintenance of Fans',
      'NFPA 96 (2024) §7.3 — Airflow Performance Requirements',
    ],
    frequency: 'Quarterly recommended; minimum semi-annual per NFPA 96 §11.6',
    ...
    complianceConsequence: `Non-performing exhaust system = NFPA 96 §11.4 and §7.3 violation. AHJ inspectors increasingly check fan maintenance records during fire safety visits. A fan with no service history in 2+ years is an inspection red flag regardless of visual condition.`,
    costDrivers: [
      {
        id: 'daily_revenue',
        label: 'Average Daily Revenue',
    ...
    riskCalculations: [
      {
        ...
        regulatoryBasis: 'NFPA 96 (2024) §11.4 — kitchen cannot operate without compliant exhaust system',
        probability: 'High',
      ...
      },
      {
        ...
        regulatoryBasis: 'NFPA 96 (2024) §11.4 — fan maintenance requirement',
        probability: 'High',
      ...
      },
      {
        ...
        regulatoryBasis: 'NFPA 96 (2024) §7.3 — airflow performance as fire safety requirement',
        probability: 'Medium',
        calculate: (i) => ({
  ...
  // ──────────────────────────────────────────────────────
  {
    ...
    shortDescription: 'Scheduled replacement of hood baffle filters with professionally cleaned certified units — NFPA 96 §11.2 and Clean Water Act §402 compliant',
    ...
    nfpaReference: 'NFPA 96 (2024) §11.2 — Inspection and Cleaning of Grease Removal Devices',
    additionalRegs: [
      'NFPA 96 (2024) §11.2.1 — grease filter condition requirements',
    ...
    operationalImpact: `Saturated filters restrict hood airflow, increase kitchen heat, and allow grease to bypass directly into the duct system — accelerating the rate at which the duct becomes non-compliant. Missing or damaged filters are an immediate NFPA 96 §11.2 citation. Every kitchen washing its own filters in a dish sink is generating a potential Clean Water Act violation — a federal issue governed by the same law that applies to industrial discharge, not just a local health code issue.`,
    ...
    complianceConsequence: `Missing, damaged, or improperly maintained filters = NFPA 96 §11.2 violation on fire inspection. On-site filter washing = potential Clean Water Act federal violation + California Regional Water Board enforcement exposure.`,
    costDrivers: [
      {
        id: 'num_filters',
    ...
    riskCalculations: [
      ...
      },
      {
        ...
        regulatoryBasis: 'NFPA 96 (2024) §11.2 — filter performance directly affects duct grease accumulation rate',
        probability: 'High',
  ...
  // ──────────────────────────────────────────────────────
  {
    ...
    nfpaReference: 'NFPA 96 (2024) §11.6.3 — Grease Collection and Disposal',
    additionalRegs: [
      'NFPA 96 (2024) §11.6 — Exhaust System Rooftop Requirements',
    ...
    complianceConsequence: `Visible rooftop grease accumulation = NFPA 96 §11.6.3 violation on fire inspection. AHJs in California are increasingly including rooftop grease in commercial kitchen fire safety reviews. Stormwater grease discharge from roof runoff can trigger NPDES enforcement.`,
    costDrivers: [
      {
        id: 'roof_sqft',
