  ...
  hood: {
    ...
    options: [
      { label: 'Exhaust fan not running at all', next: {
        ...
        regulatoryNote: 'NFPA 96 Chapter 11 requires functional exhaust during cooking operations. Verify specific requirements with your AHJ.',
      ...
      { label: 'Fan is running but hood is not pulling smoke', next: {
        ...
        preventionSteps: ['Clean hood filters daily or per shift', 'Regular filter exchange service', 'Hood and duct cleaning per NFPA 96 Table 12.4 schedule'],
        whenToCallProfessional: 'Within 24 hours if filter cleaning does not resolve.',
        regulatoryNote: 'NFPA 96 Chapter 11 covers air movement requirements. Verify specific requirements with your AHJ.',
  ...
  fire_suppression: {
    ...
    options: [
      ...
      { label: 'Expired inspection tag or missing pin', next: {
        ...
        regulatoryNote: 'NFPA 96 Chapter 12 covers fire suppression system requirements. Verify with your AHJ.',
  ...
  rooftop: {
    ...
    options: [
      { label: 'Grease accumulation on roof surface', next: {
        ...
        regulatoryNote: 'NFPA 96 Chapter 11 covers exhaust system rooftop requirements. Verify with your AHJ. Grease runoff into storm drains is a Clean Water Act violation.',
  ...
  hvac: {
    ...
    options: [
      ...
      { label: 'Make-up air system not running', next: {
        ...
        regulatoryNote: 'Make-up air system performance affects hood capture effectiveness per NFPA 96 Chapter 11. Verify with your AHJ.',
