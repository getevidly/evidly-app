...
export const DEMO_INTELLIGENCE_INSIGHTS: IntelligenceInsight[] = [
  ...
  },
  {
    ...
    impact_level: 'medium',
    urgency: 'standard',
    title: 'Two Competitor Restaurant Closures Within 2 Miles of Your Location 1',
    headline: 'Health department closed 2 restaurants near your Location 1 — their customers are now available to you.',
    summary: 'Fresno County Environmental Health issued immediate closure orders to two food service operations within 1.8 miles of your Location 1 on February 19, 2026. One closure was due to repeat temperature violations, the other for pest infestation. Both operations have been closed for a minimum 72-hour reinspection period.',
    full_analysis: 'Fresno County Environmental Health enforcement records show two immediate closure orders issued on February 19, 2026 within the Fresno dining district near Location 1: (1) "Fresh Kitchen & Grill" at 810 Van Ness Ave (1.2 miles from Location 1) — closed for repeat critical temperature violations including walk-in cooler at 52°F and hot holding unit at 118°F. This was the second closure in 6 months. (2) "Valley Bistro" at 1245 Fulton St (1.8 miles from Location 1) — closed for active pest infestation with evidence of rodent activity in dry storage and food preparation areas.\n\nBoth operations face 72-hour minimum closure with reinspection before reopening. Historical data shows that competitor closures in the Fresno area near Location 1 result in a measurable 8-15% increase in foot traffic to nearby compliant operations, with the effect lasting 2-4 weeks after the closed operation reopens.',
    executive_brief: 'Competitor closures near your Location 1 represent a short-term customer capture opportunity. Operations that maintain visible compliance certifications (QR passport, grade postings) are positioned to capture displaced customers. Estimated 200-400 displaced diners.',
    action_items: [
      'Ensure your compliance QR passport is prominently displayed at Location 1',
    ...
    tags: ['competitor', 'closure', 'Fresno', 'Location 1', 'opportunity'],
  ...
  // ── Insights 9-15: Additional coverage areas ──
  {
    ...
    executive_brief: 'New Merced County inspector focuses heavily on temperature documentation completeness. Your Location 2 location should be prepared for a documentation-focused inspection within the next 30 days.',
    action_items: [
      'Audit temperature log completeness at Location 2 for the last 30 days',
      ...
      'Consider upgrading to automated temperature monitoring at Location 2',
    ],
    affected_pillars: ['food_safety'],
  ...
  },
  {
    ...
    headline: 'Industry average food safety scores fell 2.3 points in Q4 2025 \u2014 your Location 1 now ranks in the 89th percentile.',
    summary: 'EvidLY\'s California food service benchmark data shows a 2.3-point decline in average food safety scores across 2,400 monitored locations in Q4 2025. The decline is attributed to holiday season staffing shortages and increased operational tempo. Your Location 1 location, with a food safety score of 96, now ranks in the 89th percentile, up from the 84th percentile in Q3.',
    full_analysis: 'EvidLY benchmark analysis across 2,400 California food service locations shows the statewide average food safety score declined from 79.2 to 76.9 (-2.3 points) in Q4 2025. Primary drivers: (1) Holiday staffing — temporary workers with less training contributed to 34% more checklist failures in November-December; (2) Increased operational tempo — higher volume during holiday season correlated with 18% more temperature exceedances; (3) Deferred maintenance — equipment service appointments were postponed 22% more frequently during the holiday period.\n\nYour organization\'s relative position improved as a result. Location 1 (96) moved from 84th to 89th percentile. Location 2 (84) moved from 62nd to 68th percentile. Location 3 (72) remained at approximately the 41st percentile. The benchmark shift presents a marketing opportunity to emphasize your compliance position to customers and business partners.',
    executive_brief: 'Industry-wide score decline improves your relative competitive position without any operational changes. Your Location 1 is now top-decile in California. Consider leveraging this in customer-facing materials.',
    action_items: [
...
export const DEMO_EXECUTIVE_SNAPSHOT: ExecutiveSnapshot = {
  ...
  executive_summary: 'Pacific Coast Dining\'s compliance posture is stable with improving food safety metrics (+2.1 points, 30-day trend) offset by a facility safety decline (-1.3 points) driven by overdue equipment inspections at Location 3. Two critical external intelligence alerts require immediate action: an FDA Class I romaine lettuce recall affecting your supply chain, and an active salmonella investigation in Stanislaus County that will likely trigger unannounced inspections at your Location 3 location this week.\n\nYour competitive position is strengthening — two competitor closures near Location 1 and an industry-wide benchmark decline have moved your Location 1 into the 89th percentile. However, regulatory headwinds are building: NFPA 96 2025 edition enforcement begins July 1 (4-month preparation window), and AB-2890 food handler recertification is advancing with 73% passage probability. Financial exposure across all locations ranges from $125,000 to $380,000 if identified risks materialize without mitigation. Recommended immediate actions focus on recall response, Stanislaus County inspection readiness, and hood cleaning documentation at Fresno locations.',
  risk_heatmap: [
  ...
  threats: [
    ...
    { title: 'Stanislaus County Salmonella Investigation', detail: '14 cases linked to poultry — expect unannounced inspections at Location 3 within days.' },
    { title: 'Fresno Hood Cleaning Enforcement Surge', detail: '47% citation increase — your Location 1 is in the enforcement zone.' },
  ],
  opportunities: [
    { title: 'Competitor Closures Near Location 1', detail: 'Two closures within 2 miles create short-term customer capture opportunity (200-400 displaced diners).' },
    { title: 'Benchmark Position Improvement', detail: 'Industry-wide score decline moved Location 1 to 89th percentile — leverage in marketing and insurance negotiations.' },
  ...
  correlation_analysis: [
    { external_event: 'Fresno hood cleaning enforcement surge (+47%)', internal_impact: 'Location 1 hood cleaning logs show last service 67 days ago (within compliance but approaching threshold)', strength: 'strong', action: 'Schedule hood cleaning at Location 1 within 10 days to stay ahead of enforcement window' },
    { external_event: 'Stanislaus County salmonella investigation (14 cases)', internal_impact: 'Location 3 poultry temp logs show 2 readings at 162\u00B0F (below 165\u00B0F minimum) last week', strength: 'strong', action: 'Immediately retrain Location 3 staff on poultry cooking temperature verification' },
    ...
    { external_event: 'Central Valley heat advisory (June 15-22)', internal_impact: 'Location 2 walk-in cooler already trending warm — heat event will exacerbate', strength: 'moderate', action: 'Schedule preventive maintenance on Location 2 cooler before May 30' },
  ],
  competitor_landscape: {
    closures: 2,
    failed_inspections: 3,
    position: 'competitive',
    summary: 'Two competitor closures within 2 miles of Location 1 (Fresh Kitchen & Grill, Valley Bistro). Three failed inspections in Merced County in the last 30 days. Your operations are in a competitive compliance position with Location 1 ranking 89th percentile and Location 2 at 68th percentile.',
  },
  regulatory_forecast: [
  ...
  strategic_recommendations: [
    ...
    { priority: 2, recommendation: 'Prepare Location 3 for unannounced Stanislaus County inspection', rationale: 'Active salmonella investigation in the county will trigger increased inspections. Two poultry temp readings below 165\u00B0F last week create vulnerability.', estimated_impact: 'Prevents potential citation ($2,500-$7,000) and closure risk', timeframe: 'This week', immediate: true },
    { priority: 3, recommendation: 'Schedule hood cleaning at Location 1 within 10 days', rationale: 'Fresno County enforcement surge (+47% citations) combined with last service 67 days ago creates elevated risk.', estimated_impact: 'Prevents $8,000-$45,000 closure and emergency service costs', timeframe: '10 days', immediate: false },
...
export const DEMO_COMPETITOR_EVENTS: CompetitorEvent[] = [
  { id: 'comp-001', type: 'closure', business_name: 'Fresh Kitchen & Grill', distance_miles: 1.2, near_location: 'Location 1', reason: 'Repeat critical temperature violations (walk-in 52\u00B0F, hot hold 118\u00B0F)', date: '2026-02-19', source: 'Fresno County EH' },
  { id: 'comp-002', type: 'closure', business_name: 'Valley Bistro', distance_miles: 1.8, near_location: 'Location 1', reason: 'Active pest infestation — rodent activity in dry storage and prep areas', date: '2026-02-19', source: 'Fresno County EH' },
  { id: 'comp-003', type: 'failed_inspection', business_name: 'Sunrise Diner', distance_miles: 3.4, near_location: 'Location 2', reason: '6 critical violations including improper food storage and handwashing', date: '2026-02-15', source: 'Merced County DPH' },
  { id: 'comp-004', type: 'citation', business_name: 'Campus Eats', distance_miles: 0.8, near_location: 'Location 3', reason: 'Fire suppression system expired, hood cleaning overdue by 3 months', date: '2026-02-12', source: 'Stanislaus County DER' },
];
