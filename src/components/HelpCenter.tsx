...
const helpArticles: HelpArticle[] = [
  ...
  { id: '2', title: 'Understanding Your Compliance Score', category: 'Dashboard', summary: 'How the 3-pillar scoring works: Operational (45%), Equipment (30%), Documentation (25%).', icon: FileText },
