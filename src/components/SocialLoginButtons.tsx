  ...
  return (
    <div className="space-y-3 mb-6">
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl font-medium text-sm focus-visible:outline-none focus-visible:ring-2 focus:ring-offset-2 focus:ring-[#B24A2E] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
        style={{
          background: '#FFFFFF',
          border: '1.5px solid #E5E0D8',
          color: '#1E2D4D',
        }}
        onMouseEnter={e => { e.currentTarget.style.background = '#FAF7F0'; e.currentTarget.style.borderColor = '#B24A2E'; }}
