...
export const DEMO_ATTENTION_ITEMS: AttentionItem[] = [
  {
    ...
    actionLabel: 'View',
    actionRoute: '/temp',
    locationId: 'tuolumne-meadows',
    locationName: 'Tuolumne Meadows',
    daysUntilDue: 0,
  },
  {
    id: 'att-2',
    ...
    actionRoute: '/vendors/fire-suppression',
    locationId: 'badger-pass',
    locationName: 'Badger Pass',
    daysUntilDue: 12,
  },
  {
    id: 'att-3',
    ...
    locationId: 'valley-lodge',
    locationName: 'Valley Lodge',
    daysUntilDue: 0,
  },
  {
    id: 'att-4',
    ...
    locationId: 'village-grill',
    locationName: 'Village Grill',
    daysUntilDue: 18,
  },
  {
    id: 'att-5',
