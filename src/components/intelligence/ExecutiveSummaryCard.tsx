...
The most urgent operational risk is Location 3, which requires immediate intervention. With 6 open items, a reinspection window closing March 1, and checklist completion at 54% and falling, this location is on track for a failed reinspection. Location 2's fire safety failure compounds the organizational risk — two of three locations now carry active compliance deficiencies. The declining trends at both locations suggest the root cause has not been addressed. // demo

Three strategic priorities: First, deploy management support to Location 3 before the March 1 reinspection — a reinspection failure at current trajectory is near-certain without intervention. Second, remediate Location 2's fire safety failure and address the 18-day hood cleaning certificate expiration before it compounds into a multi-violation scenario. Third, replicate Location 1's operational model (staffing stability, checklist discipline, management oversight) as the organizational standard. The compliance gap between your best and worst locations represents a 42-point spread — closing that gap by even half would materially change the risk profile.`, // demo

  risk: `Your Organization faces $520,500 in estimated annual risk exposure, concentrated overwhelmingly at two locations. Location 3 represents $385,000 of that exposure — a single location carrying 74% of the organization's total regulatory and legal risk. This location has an active "Action Required" food safety status, a failed fire safety inspection, a health permit expiring in 7 days, and a hood cleaning certificate expiring in 3 days. If the hood cleaning certificate expires while the fire safety failure remains unresolved, the AHJ has grounds for immediate closure under NFPA 96 enforcement. Location 2 adds $127,000 in exposure with its own fire safety failure and 18-day hood cleaning certificate expiration. // demo

The specific threat chain at Location 3 is: hood cleaning certificate expires in 3 days → fire safety non-compliance confirmed → health permit expires in 7 days → reinspection due March 1 with 6 open items → if reinspection fails, the AHJ may issue a closure notice. Each of these events compounds the next. Separately, Location 2's fire suppression inspection expires in 45 days — if that location enters reinspection with both a fire safety failure and an expired fire suppression certificate, the probability of enforcement action increases substantially. Two active permit expirations within 30 days across the organization is a critical documentation gap. // demo

Priority 1: Renew Location 3's hood cleaning certificate within 48 hours — this is the single highest-impact action available. Priority 2: Resolve Location 3's food safety violations before the March 1 reinspection. Priority 3: Address Location 2's fire safety failure and schedule hood cleaning certificate renewal. These three actions would reduce total organizational risk exposure by an estimated 60-70%.`, // demo
