...
The most urgent operational risk is University Dining, which requires immediate intervention. With 6 open items, a reinspection window closing March 1, and checklist completion at 54% and falling, this location is on track for a failed reinspection. Airport Cafe's facility safety failure compounds the organizational risk — two of three locations now carry active compliance deficiencies. The declining trends at both locations suggest the root cause has not been addressed.
