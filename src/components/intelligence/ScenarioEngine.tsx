  ...
  // ── RISK SCENARIOS ────────────────────────────────────
  {
    ...
    contextFields: [
      ...
      { key: 'violationType',   label: 'Violation Type',              placeholder: '',                                  type: 'select',   required: true,
        options: ['Food Safety — Major Violation', 'Food Safety — Multiple Minor Violations', 'Fire Safety — NFPA 96 Non-Compliance', 'Both Food and Fire Safety', 'Permit / Documentation'] },
...
For each pathway: dollar range, probability, timeline, and single action that prevents it. End with: cost to resolve today vs. cost of each scenario.`,
  },
  {
    ...
    contextFields: [
      ...
      { key: 'affectedLocations', label: 'Affected Location(s)',                    placeholder: 'e.g. Location 2', type: 'text',   required: true }, // demo
...
End with specific breakeven: when does cost of deferral exceed cost of the service?`,
  ...
  },
  {
    ...
    contextFields: [
      ...
      { key: 'concerns', label: 'Known Concerns the Audience Has', placeholder: 'e.g. Board is worried about the Location 3 location, investors want to see consistency across all sites', type: 'textarea', required: false }, // demo
    ],
