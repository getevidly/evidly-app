      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '12px', marginBottom: '20px' }}>
        {[
          ...
          <div key={i} style={{
            ...
            <p style={{ color: '#3D5068', fontSize: '11px', margin: 0, fontFamily: 'system-ui' }}>{m.sub}</p>
          </div>
        ))}
      </div>

      {/* Per-location breakdown */}
      <h3 style={{ color: '#3D5068', fontSize: '12px', fontWeight: 600, margin: '0 0 10px', textTransform: 'uppercase', letterSpacing: '0.5px', fontFamily: 'system-ui' }}>
        By Location
      </h3>
      {data.complianceMatrix.map((loc: any) => (
        <div key={loc.locationId} style={{
          display: 'flex', alignItems: 'center', justifyContent: 'space-between',
          padding: '10px 0', borderBottom: '1px solid #D1D9E6',
        }}>
          <div>
          ...
          <div style={{ display: 'flex', gap: '20px', textAlign: 'right' }}>
            <div>
              ...
              <p style={{ color: '#3D5068', fontSize: '10px', margin: '1px 0 0', fontFamily: 'system-ui' }}>exposure</p>
            </div>
            <div>
              ...
              <p style={{ color: '#3D5068', fontSize: '10px', margin: '1px 0 0', fontFamily: 'system-ui' }}>savings</p>
            </div>
          </div>
        </div>
      ))}
