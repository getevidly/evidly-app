        ...
        <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3" style={{ backgroundColor: '#faf8f3' }}>
          {messages.length === 0 && !isTyping && (
            <div className="text-center pt-8">
              <Brain className="h-10 w-10 mx-auto mb-3" style={{ color: '#B24A2E' }} />
          ...
          {isTyping && (
            <div className="flex justify-start">
              <div className="bg-white border border-[#1E2D4D]/10 rounded-xl px-3 py-2 flex items-center gap-2">
                <Loader2 className="h-4 w-4 animate-spin text-[#B24A2E]" />
        ...
        <div className="flex-shrink-0 px-4 py-3 border-t border-[#1E2D4D]/10 bg-white">
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-3 py-2 border border-[#1E2D4D]/15 rounded-xl text-sm focus-visible:outline-none focus-visible:ring-2 focus:ring-[#B24A2E] focus:border-transparent"
              disabled={isTyping}
            />
            <button
