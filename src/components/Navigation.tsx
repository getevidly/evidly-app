...
export default function Navigation() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-[1000] bg-white/95 backdrop-blur-[20px] border-b border-[#1E2D4D]/10">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="sm:hidden inline-flex items-center justify-center w-11 h-11 rounded-lg text-[var(--color-blue)] hover:bg-[#1E2D4D]/5 transition-colors border-none bg-transparent cursor-pointer"
        ...
        {mobileMenuOpen && (
          <div className="sm:hidden border-t border-[#1E2D4D]/10 bg-white px-4 pb-4">
            <div className="flex flex-col gap-1 py-3">
              <a href="#features" onClick={() => setMobileMenuOpen(false)} className="no-underline text-[var(--color-text-light)] font-medium text-base min-h-[44px] flex items-center px-3 rounded-lg hover:bg-[#FAF7F0] transition-colors">Features</a>
              <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className="no-underline text-[var(--color-text-light)] font-medium text-base min-h-[44px] flex items-center px-3 rounded-lg hover:bg-[#FAF7F0] transition-colors">Pricing</a>
              <a href="mailto:launch@getevidly.com" onClick={() => setMobileMenuOpen(false)} className="no-underline text-[var(--color-text-light)] font-medium text-base min-h-[44px] flex items-center px-3 rounded-lg hover:bg-[#FAF7F0] transition-colors">Contact</a>
            </div>
            <div className="flex flex-col gap-2 pt-3 border-t border-[#1E2D4D]/10">
