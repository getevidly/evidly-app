      ...
      <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="flex items-center gap-3 mb-5">
                ...
                {category.title !== 'Coming Soon' && (
                  <span className="text-xs font-bold uppercase tracking-wider text-green-700 bg-green-100 px-2 py-0.5 rounded-full">Available Now</span>
                )}
              </div>
        ...
        <div className="mt-12 text-center">
          ...
          <button
            ...
            className="inline-block px-8 py-4 bg-[#1E2D4D] text-white rounded-xl font-semibold hover:bg-[#162340] shadow-sm hover:shadow-xl transition-all min-h-[44px]"
          >
            See Pricing
          </button>
        </div>
