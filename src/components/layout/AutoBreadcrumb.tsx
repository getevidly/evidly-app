...
const PARENT_ROUTES: Record<string, { label: string; href: string }> = {
  ...
  '/admin/onboard-client': { label: 'Admin', href: '/admin/onboard-client' },
  '/admin/usage-analytics': { label: 'Admin', href: '/admin/usage-analytics' },
  '/admin/regulatory-changes': { label: 'Admin', href: '/admin/regulatory-changes' },
