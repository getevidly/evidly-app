...
const ROUTE_LABELS: Record<string, string> = {
  ...
  '/allergen-tracking': 'Allergen Tracking',
  '/cooling-logs': 'Cooling Logs',
  '/receiving-log': 'Receiving Log',
  '/billing': 'Billing',
  '/equipment/hood-exhaust': 'Hood & Exhaust',
  '/equipment/hvac': 'HVAC',
  '/equipment/ice-machines': 'Ice Machines',
  '/equipment/refrigeration': 'Refrigeration',
  '/equipment/suppression-systems': 'Suppression Systems',
...
const PARENT_ROUTES: Record<string, { label: string; href: string }> = {
  ...
  '/equipment/hood-exhaust': { label: 'Equipment', href: '/equipment' },
  '/equipment/hvac': { label: 'Equipment', href: '/equipment' },
  '/equipment/ice-machines': { label: 'Equipment', href: '/equipment' },
  '/equipment/refrigeration': { label: 'Equipment', href: '/equipment' },
  '/equipment/suppression-systems': { label: 'Equipment', href: '/equipment' },
};
