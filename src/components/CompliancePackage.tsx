...
const packageDocuments: PackageDocument[] = [
  ...
  { name: 'Hood Cleaning Certificate', category: 'Facility Safety', status: 'included', date: 'Jan 15, 2026' },
  { name: 'Fire Suppression Inspection', category: 'Facility Safety', status: 'expired', date: 'Exp: Feb 10, 2026' },
  { name: 'Fire Extinguisher Tags', category: 'Facility Safety', status: 'included', date: 'Nov 2025' },
...
const packagePresets: Record<PackageType, { label: string; description: string; icon: typeof EvidlyIcon | typeof FileText | typeof Building; docs: string[] }> = {
  ...
  insurance: {
    ...
    description: 'For insurance inspections and renewals — COI, facility safety docs, vendor certifications',
    icon: FileText,
  ...
  landlord: {
    ...
    description: 'Proof of compliance for lease requirements — permits, insurance, facility safety',
    icon: Building,
