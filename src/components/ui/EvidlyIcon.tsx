 ...
 *
 * Navy rounded-rect bg (#1E2D4D), 5 gold dots (#B24A2E) in pentagon,
...
export const EvidlyIcon: React.FC<EvidlyIconProps> = ({ size = 40, className }) => (
  ...
  >
    ...
    <circle cx="50" cy="22" r="10" fill="#B24A2E" />
    <circle cx="22" cy="42" r="10" fill="#B24A2E" />
    <circle cx="78" cy="42" r="10" fill="#B24A2E" />
    <circle cx="32" cy="74" r="10" fill="#B24A2E" />
    <circle cx="68" cy="74" r="10" fill="#B24A2E" />
