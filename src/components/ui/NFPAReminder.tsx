...
const REMINDERS: Reminder[] = [
  { month: 1,  urgency: 'reminder',  title: 'Start the Year — Review Hood Cleaning Schedule',
    ...
    action: 'Log your cooking type and set cleaning reminders in EvidLY Facility Safety for all 12 months.' },
  { month: 2,  urgency: 'important', title: 'Insurance Renewal Season — Is Your Documentation Ready?',
    standard: 'NFPA 96 Chapter 13',
    benefit: 'Most commercial kitchen policies renew in Q1. Carriers are increasingly requesting NFPA 96 maintenance documentation before issuing renewals. Operators with complete EvidLY records have everything ready when the broker asks.',
    action: 'Export your Facility Safety documentation report. Confirm all certificates and inspection records are current.' },
  { month: 3,  urgency: 'important', title: 'Spring Inspection Season — Self-Inspect Before They Arrive',
    standard: 'NFPA 96 Chapter 8 — Hood Systems',
  ...
  { month: 4,  urgency: 'reminder',  title: 'Grease Removal Devices — Filter Condition Check',
    standard: 'NFPA 96 Chapter 9 — Grease Removal Devices',
    benefit: 'NFPA 96 Chapter 9 governs grease filter maintenance. Clean filters reduce duct grease load by 40–60%, directly extending the interval between required cleanings.',
  ...
  { month: 5,  urgency: 'important', title: 'Pre-Summer Fan Check — Before Volume Increases',
    standard: 'NFPA 96 Chapter 11 — Air Movement',
  ...
  { month: 7,  urgency: 'reminder',  title: 'Rooftop Grease — Summer UV Accelerates Membrane Damage',
    standard: 'NFPA 96 Chapter 12 — Fire Suppression Systems',
  ...
  { month: 8,  urgency: 'important', title: 'Back to School — New Staff Compliance Risk',
    standard: 'NFPA 96 Chapter 13 — Procedures for the Use of the System',
    benefit: 'New seasonal hires are the #1 leading indicator of compliance gaps. EvidLY data shows checklist completion drops 15–25% in the first month with new staff. NFPA 96 Chapter 13 covers system procedures staff must know.',
    action: 'Complete facility safety training documentation in EvidLY for all new staff. Monitor checklist completion rates.' },
  ...
  { month: 11, urgency: 'critical',  title: 'Holiday Volume — Highest Risk Period of the Year',
    standard: 'NFPA 96 Chapter 10 — Exhaust Duct Systems',
  ...
  { month: 12, urgency: 'reminder',  title: 'Year-End Documentation — Close the Year Clean',
    standard: 'NFPA 96 Chapter 13',
    benefit: 'December is the time to ensure all 2026 facility safety documentation is complete, correctly filed, and accessible. End-of-year reports from EvidLY take 5 minutes and impress insurers, auditors, and enterprise clients.',
