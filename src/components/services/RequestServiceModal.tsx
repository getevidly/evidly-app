      ...
      <div className="relative bg-white rounded-2xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        {submitted ? (
          <div className="p-8 text-center">
            ...
            {calEvent && !isDemoMode && (
              <div className="space-y-2 mb-6 text-left">
                <p className="text-xs font-medium text-gray-500 uppercase tracking-wider text-center">Add to Calendar</p>
                <a
                  href={getGoogleCalendarUrl(calEvent)}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 px-4 py-2 border border-gray-200 rounded-lg hover:bg-gray-50 text-sm font-medium text-gray-700"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-2 border border-gray-200 rounded-lg hover:bg-gray-50 text-sm font-medium text-gray-700"
                >
                  <CalendarDays className="h-4 w-4" />
                  Download .ics
                </button>
          ...
          <div className="p-6 space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Proposed Date & Time Slots</label>
              <p className="text-xs text-gray-500 mb-2">Suggest up to 3 times that work for your schedule.</p>
              <div className="space-y-2">
