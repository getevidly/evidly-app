...
/* ── Rings (on navy) ────────────────────────────────────── */
.ev-rings-w{display:flex;flex-direction:column;align-items:center;gap:15px;flex:none;margin-top:8px}
.ev-rings-h{position:relative;display:inline-flex;align-items:center;gap:6px;cursor:default;
  font-family:'IBM Plex Mono',monospace;font-size:10px;font-weight:500;letter-spacing:.18em;color:rgba(255,255,255,.5)}
.ev-qmark{width:13px;height:13px;border-radius:50%;border:1px solid rgba(255,255,255,.35);color:rgba(255,255,255,.5);
...
.ev-rings-h:hover .ev-qmark{border-color:#fff;color:#fff}
.ev-tip{position:absolute;top:calc(100% + 9px);left:50%;transform:translateX(-50%) translateY(-4px);
  background:#fff;color:#1C2A3A;font-family:'IBM Plex Mono',monospace;font-size:10px;letter-spacing:.04em;
  padding:9px 12px;border-radius:7px;white-space:nowrap;pointer-events:none;opacity:0;
  transition:opacity .18s ease,transform .18s ease;z-index:20;box-shadow:0 8px 22px -10px rgba(0,0,0,.35)}
...
.ev-rings{display:flex;gap:28px;justify-content:center}
...
.ev-pct{font-family:'Instrument Sans',system-ui,sans-serif;font-size:26px;font-weight:700;color:#fff;line-height:1;
  letter-spacing:-.02em;transition:transform .3s cubic-bezier(.34,1.4,.64,1)}
.ev-ring-w:hover .ev-pct{transform:translateY(-2px)}
.ev-of{font-family:'IBM Plex Mono',monospace;font-size:11px;color:rgba(255,255,255,.55);margin-top:6px;transition:color .25s ease}
.ev-ring-w:hover .ev-of{color:rgba(255,255,255,.75)}
.ev-ring-meta{display:flex;flex-direction:column;align-items:center;gap:7px}
.ev-ring-name{font-family:'Instrument Sans',system-ui,sans-serif;font-size:14px;font-weight:700;color:#fff;letter-spacing:-.01em}
.ev-ring-state{font-family:'IBM Plex Mono',monospace;font-size:9.5px;font-weight:500;letter-spacing:.13em;
...
.ev-ring-state.ready{background:rgba(62,94,75,.45);color:#BFD6C0}
.ev-ring-state.notready{background:rgba(158,59,50,.35);color:#E5B9B2}
...
.ev-sh{display:flex;align-items:baseline;gap:12px;flex-wrap:wrap;margin:20px 0 14px}
.ev-sh:first-child{margin-top:8px}
...
.ev-sh .ev-pill{font-family:'IBM Plex Mono',monospace;font-size:9.5px;font-weight:500;letter-spacing:.13em;
...
.ev-sh .ev-auto{font-family:'IBM Plex Mono',monospace;font-size:9.5px;letter-spacing:.12em;color:#A79E8B}

/* ── Chips ──────────────────────────────────────────────── */
.ev-chip{font-family:'IBM Plex Mono',monospace;font-size:9px;font-weight:500;letter-spacing:.11em;
...
.ev-pc-c{font-family:'IBM Plex Mono',monospace;font-size:9.5px;letter-spacing:.09em;color:#A79E8B;margin-top:8px}
...
.ev-pcol-k{font-family:'IBM Plex Mono',monospace;font-size:9.5px;font-weight:500;letter-spacing:.12em;
...
.ev-pcol-tip{position:absolute;top:calc(100% + 8px);left:0;background:#1C2A3A;color:#fff;font-family:'Instrument Sans',system-ui,sans-serif;
  font-size:11.5px;font-weight:400;letter-spacing:0;line-height:1.55;padding:11px 13px;
...
.ev-ceil-k{font-family:'IBM Plex Mono',monospace;font-size:10px;letter-spacing:.1em}
...
.ev-sens-c{background:#fff;border:1px solid #E4DBC8;border-radius:10px;padding:16px 18px;
  box-shadow:0 1px 2px rgba(28,42,58,.03),0 16px 34px -30px rgba(28,42,58,.55)}
.ev-sens-cat{font-family:'IBM Plex Mono',monospace;font-size:9.5px;letter-spacing:.11em;color:#B24A2E}
...
.ev-rc-c{font-family:'IBM Plex Mono',monospace;font-size:9.5px;letter-spacing:.09em;color:#A79E8B;margin-top:7px}
...
.ev-rtag{font-family:'IBM Plex Mono',monospace;font-size:9px;letter-spacing:.1em;color:#A79E8B;flex:none}
...
.ev-ex-k{font-family:'IBM Plex Mono',monospace;font-size:10.5px;letter-spacing:.16em;color:#2C5570;font-weight:700}
.ev-ex-n{font-family:'IBM Plex Mono',monospace;font-size:10px;letter-spacing:.05em;color:#9AA7B0}
...
.ev-ex-h{font-family:'IBM Plex Mono',monospace;font-size:10px;letter-spacing:.12em;color:#B24A2E;
...
.ev-ex-sub{font-family:'IBM Plex Mono',monospace;font-size:10px;letter-spacing:.12em;color:#6E675A;
...
.ev-ex-cond{font-family:'IBM Plex Mono',monospace;font-size:9px;letter-spacing:.09em;color:#A79E8B;
...
.ev-ask-when{font-family:'IBM Plex Mono',monospace;font-size:9.5px;letter-spacing:.11em;color:#A79E8B;margin-top:5px}
