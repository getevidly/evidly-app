  ...
  return (
    <section className="pt-[140px] pb-[100px] px-6 relative overflow-hidden bg-gradient-to-b from-white to-[var(--color-gold-bg)]">
      ...
      <div className="max-w-[800px] mx-auto text-center relative">
        ...
        <p className="text-[1.125rem] text-[var(--color-blue)] font-semibold mb-6 max-w-[600px] mx-auto">
          Relax knowing everything is documented, verified, and inspection-ready
        </p>
