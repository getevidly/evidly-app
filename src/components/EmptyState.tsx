  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center animate-fade-in">
      <div className="w-16 h-16 rounded-full flex items-center justify-center mb-4 bg-[#FAF7F0]">
        <Icon className={iconClassName || "w-8 h-8 text-[#1E2D4D]"} />
      </div>
      ...
      {action && (
        <button
          ...
          className="px-5 py-2.5 bg-[#1E2D4D] text-white rounded-xl font-medium transition-all hover:bg-[#162340] hover:-translate-y-0.5 hover:shadow-md min-h-[44px]"
        >
          {action.label}
        </button>
      )}
