...
export function CalendarPRPBand({ stats, onPredictClick, onProveClick }: CalendarPRPBandProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      <button
        ...
        className="bg-white border border-[#E2DDD4] rounded-lg p-4 text-left cursor-pointer transition-all hover:-translate-y-0.5 hover:shadow-md"
      ...
      >
        ...
        <div className="mt-3 pt-3" style={{ borderTop: '1px dashed #E2DDD4' }}>
          ...
          <span
            className="mt-2 inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-[11px] font-bold text-white"
