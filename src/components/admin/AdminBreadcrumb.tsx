...
const SECTION_MAP: Record<string, string> = {
  ...
  '/admin/marketing/overview': 'Marketing',
  '/admin/marketing/outbound-calls': 'Marketing',
  '/admin/marketing/in-person': 'Marketing',
  '/admin/marketing/accounts': 'Marketing',
  '/admin/marketing/network': 'Marketing',
  '/admin/marketing/channels': 'Marketing',
  '/admin/marketing/survey': 'Marketing',
  '/admin/marketing/content-schedule': 'Marketing',
  '/admin/marketing/founder-window': 'Marketing',
  '/admin/marketing/funnel': 'Marketing',
  '/admin/marketing/segments': 'Marketing',
  '/admin/marketing/email-sequence': 'Marketing',
  '/admin/marketing/prp-attribution': 'Marketing',
  '/admin/marketing/seo': 'Marketing',
  '/admin/marketing/serp': 'Marketing',
