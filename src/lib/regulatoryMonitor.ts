...
export const MONITORED_SOURCES: MonitoredSource[] = [
  ...
  { name: 'NFPA 96 (Hood & Ventilation)', abbreviation: 'NFPA 96', type: 'industry', lastChecked: _daysAgo(2), url: 'https://www.nfpa.org/codes-and-standards/nfpa-96-standard-development/96' },
