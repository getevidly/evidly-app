...
export const MONITORED_SOURCES: MonitoredSource[] = [
  ...
  { name: 'NFPA 96 (2025 Edition) (Hood & Ventilation)', abbreviation: 'NFPA 96', type: 'industry', lastChecked: '2026-02-07', url: 'https://www.nfpa.org/codes-and-standards/nfpa-96-standard-development/96' },
...
export const DEMO_ALERTS: RegulatoryAlert[] = [
  ...
  // ── AWARENESS (CFC) ───────────────────────────────
  {
    ...
    summary: 'EvidLY now tracks California Fire Code (CFC) Title 24, Part 9 (2022 edition) requirements alongside food safety regulations. The CFC adopts NFPA 96 (2025 Edition) by reference with California amendments and is enforced by local fire authorities (AHJs), not the state. Key requirements include UL 300 wet chemical suppression for all Type I hoods, Class K extinguishers, bare metal hood cleaning standard, and annual fire prevention permits from your local AHJ. Fire code items are weighted as CRITICAL in compliance scoring because fire = life safety.',
    actionItems: [
