  ...
  const locationRows = data.locations
    .map(
      ...
      <tr>
        ...
        <td style="padding:10px 8px;border-bottom:1px solid #e5e7eb;text-align:center;font-size:13px;">${loc.operational}</td>
        <td style="padding:10px 8px;border-bottom:1px solid #e5e7eb;text-align:center;font-size:13px;">${loc.equipment}</td>
        <td style="padding:10px 8px;border-bottom:1px solid #e5e7eb;text-align:center;font-size:13px;">${loc.documentation}</td>
        <td style="padding:10px 12px;border-bottom:1px solid #e5e7eb;text-align:center;">
...
<tr><td style="padding:16px 32px;">
  ...
  <tr style="background:#f8fafc;">
    ...
    <th style="padding:10px 8px;text-align:center;font-size:11px;color:#6b7280;font-weight:600;">Ops</th>
    <th style="padding:10px 8px;text-align:center;font-size:11px;color:#6b7280;font-weight:600;">Equip</th>
    <th style="padding:10px 8px;text-align:center;font-size:11px;color:#6b7280;font-weight:600;">Docs</th>
