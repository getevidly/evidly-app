...
const FEDERAL: JurisdictionProfile = {
  ...
  specialRequirements: [
    ...
    'NFPA 96 (2024): Automatic fire suppression (UL 300 wet chemical) required for all hoods/ducts',
    'NFPA 96 (2024): Manual pull station required, automatic gas/electric shut-offs on suppression activation',
...
const CALIFORNIA: JurisdictionProfile = {
  ...
  specialRequirements: [
    ...
    'CFC Ch. 6.07: Adopts NFPA 96 (2024) by reference with California amendments',
    'CFC Ch. 6.07: UL 300 compliant wet chemical suppression systems mandatory for all Type I hoods',
    'CFC Ch. 6.07: Hood and duct cleaning must meet bare metal standard per NFPA 96 (2024) schedule',
