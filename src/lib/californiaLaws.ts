...
export const CALIFORNIA_STATE_LAWS: CaliforniaStateLaw[] = [
  ...
  },
  {
    ...
    description:
      'California Fire Code (2022 edition, effective Jan 1, 2023) adopts NFPA 96 (2024) by reference with California amendments. Establishes fire suppression, extinguisher, hood cleaning, and fire prevention permit requirements for all commercial kitchens. Enforced by local fire authorities (AHJs), not state.',
    requirements: [
      ...
      'CFC Ch. 6.07: Hood cleaning to bare metal standard per NFPA 96 (2024) schedule (monthly/quarterly/semi-annual/annual)',
