...
export const CALIFORNIA_STATE_LAWS: CaliforniaStateLaw[] = [
  ...
  },
  {
    ...
    description:
      'California Fire Code (2022 edition, effective Jan 1, 2023) adopts NFPA 96 (2025 Edition) by reference with California amendments. Establishes fire suppression, extinguisher, hood cleaning, and fire prevention permit requirements for all commercial kitchens. Enforced by local fire authorities (AHJs), not state.',
    requirements: [
      ...
      'CFC Ch. 6.07: Hood cleaning to bare metal standard per NFPA 96 (2025 Edition) schedule (monthly/quarterly/semi-annual/annual)',
      ...
      'CFC Ch. 9: Annual extinguisher inspection + 6-year maintenance + 12-year hydrostatic test (per NFPA 10-2025)',
