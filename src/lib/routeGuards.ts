...
const ROUTE_ROLE_MAP: [string, UserRole[]][] = [
  ...
  ['/fire-safety/kec',       ['owner_operator', 'executive', 'compliance_manager', 'facilities_manager']],
  ['/fire-safety/kec/fpm',   ['owner_operator', 'executive', 'compliance_manager', 'facilities_manager', 'kitchen_manager']],
  ['/fire-safety/kec/rgc',   ['owner_operator', 'executive', 'compliance_manager', 'facilities_manager', 'kitchen_manager']],
  ['/fire-safety/kec/gfx',   ['owner_operator', 'executive', 'compliance_manager', 'facilities_manager', 'kitchen_manager']],
  ['/fire-safety/protection',['owner_operator', 'executive', 'compliance_manager', 'facilities_manager']],
