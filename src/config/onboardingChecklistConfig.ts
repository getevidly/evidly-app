...
export const ONBOARDING_STEPS: OnboardingStepDef[] = [
  ...
  },
  {
    ...
    description: "Add each vendor's company info, contact, and the locations they serve. You can invite them separately to connect their account.",
    hint: 'Track licenses, COI status, and assignments per location',
    route: '/vendors',
  ...
  },
  {
    ...
    section: 'safety_setup',
    order: 4,
    dependsOn: ['vendors_setup', 'upload_documents'],
    roles: ['owner_operator', 'executive', 'compliance_manager', 'platform_admin'],
  },
