  ...
  platform_admin: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.documents, I.inspectorArrival, I.insuranceRisk, I.workforceRisk, I.cicPse, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.selfInspection, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
        ...
        [I.aiInsights, I.analytics, I.complianceTrends, I.auditLog, I.benchmarks, I.intelligence, I.clientIntelligence, I.clientReports, I.iotDashboard],
        '/insights',
      ),
      section('tools', 'Tools', '🔧',
  ...
  kitchen_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.documents, I.incidents, I.regulatory, I.reporting, I.selfInspection, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
        'Insights', 'Artificial Intelligence-powered analysis, analytics, compliance trends, and recommendations.',
        [I.aiInsights, I.analytics, I.complianceTrends],
        '/insights',
      ),
      section('tools', 'Tools', '🔧',
        'Tools', 'Equipment troubleshooting.',
  ...
  compliance_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.documents, I.incidentsViewOnly, I.inspectorArrival, I.insuranceRisk, I.workforceRisk, I.cicPse, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
        'Insights', 'Artificial Intelligence-powered analysis — audit logs, compliance intelligence, and Internet of Things monitoring.',
        [I.aiInsights, I.auditLog, I.intelligence, I.clientIntelligence, I.clientReports, I.iotDashboard],
        '/insights',
      ),
      section('tools', 'Tools', '🔧',
  ...
  facilities_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.reporting, I.workforceRisk, I.cicPse, I.vendorMarketplace],
        '/compliance',
      ),
  ...
  owner_operator: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.documents, I.incidents, I.insuranceRisk, I.workforceRisk, I.cicPse, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.selfInspection, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
  ...
  executive: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.correctiveActions, I.incidentsViewOnly, I.insuranceRisk, I.workforceRisk, I.cicPse, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('tools', 'Tools', '🔧',
