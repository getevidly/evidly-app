...
const ROLE_CONFIGS: Record<UserRole, RoleSidebarConfig> = {
  ...
  kitchen_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        'Compliance', 'Documentation, incidents, regulatory tracking, reporting, self-inspection, and services.',
        [I.documents, I.incidents, I.regulatory, I.reporting, I.selfInspection, I.services],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
  ...
  compliance_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        'Compliance', 'Documentation, incidents, inspector view, jurisdiction intelligence, regulatory tracking, reporting, and services.',
        [I.documents, I.incidentsViewOnly, I.inspectorArrival, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.services],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
  ...
  facilities_manager: {
    ...
    sections: [
      ...
      section('tools', 'Tools', '🔧',
        'Tools', 'Equipment troubleshooting and service Return on Investment.',
  ...
  owner_operator: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        'Compliance', 'Documents, incidents, insurance risk, regulatory tracking, reporting, self-inspection, and vendor services.',
        [I.documents, I.incidents, I.insuranceRisk, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.selfInspection, I.services],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
