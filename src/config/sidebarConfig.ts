...
const ROLE_CONFIGS: Record<UserRole, RoleSidebarConfig> = {
  ...
  kitchen_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.documents, I.haccp, I.regulatory, I.reporting, I.selfInspection, I.services],
      ),
      section('tools', 'Tools', '🔧',
        'Tools', 'Equipment troubleshooting and vendor notification.',
        [I.selfDiagnosis],
  ...
  compliance_manager: {
    ...
    sections: [
      section('compliance', 'Compliance', '📋',
        ...
        [I.correctiveActions, I.documents, I.haccp, I.regulatory, I.reporting, I.selfInspection, I.services, I.vendorCertifications],
      ),
  ...
  owner_operator: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.correctiveActions, I.documents, I.haccp, I.incidents, I.regulatory, I.selfInspection, I.services],
      ),
      section('insights', 'Insights', '💡',
  ...
  executive: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        'Compliance', 'HACCP, regulatory tracking, compliance reporting, and services.',
        [I.haccp, I.regulatory, I.reporting, I.services],
      ),
      section('administration', 'Administration', '⚙️',
