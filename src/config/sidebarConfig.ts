...
const ROLE_CONFIGS: Record<UserRole, RoleSidebarConfig> = {
  ...
  kitchen_manager: {
    ...
    topLevelItems: [I.complianceOverview, I.calendar],
    sections: [
      section('food-safety', 'Food Safety', '🍽️',
        'Food Safety', 'Checklists, temperature logs, HACCP plans, corrective actions, and food safety overview.',
  ...
  compliance_manager: {
    ...
    sections: [
      ...
      section('facility-safety', 'Fire Safety', '🔥',
        'Fire Safety', 'Fire safety compliance and fire inspection readiness.',
        [I.fireSafetyAnalysis, I.fireSafetyTrajectory], '/facility-safety',
      ),
      section('compliance', 'Compliance', '📋',
  ...
  facilities_manager: {
    ...
    sections: [
      section('facility-safety', 'Fire Safety', '🔥',
        ...
        [I.fireSafetyAnalysis, I.fireSafetyTrajectory, I.incidents, I.correctiveActions, I.inspectorArrival], '/facility-safety',
      ),
      section('compliance', 'Compliance', '📋',
