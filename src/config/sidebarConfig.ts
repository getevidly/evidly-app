  ...
  platform_admin: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.deficiencies, I.documents, I.inspectorArrival, I.insuranceRisk, I.workforceRisk, I.cicPse, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.selfInspection, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      ...
      section('administration', 'Administration', '⚙️',
        ...
        [I.equipment, I.integrations, I.iotSensors, I.locations, I.settings, I.rolesPermissions, I.team, I.timecards, I.employees, I.trainingRecords, I.trainingCatalog, I.vendors],
        '/admin',
      ),
  ...
  chef: {
    ...
    sections: [
      ...
      section('administration', 'Administration', '⚙️',
        ...
        [I.team, I.timecards, I.employees, I.trainingRecords],
        '/admin',
      ),
      section('help', 'Help', '❓',
        'Help', 'Documentation, support, and contact options.',
  ...
  kitchen_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.deficiencies, I.documents, I.incidents, I.regulatory, I.reporting, I.selfInspection, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
      ...
      section('administration', 'Administration', '⚙️',
        ...
        [I.settings, I.team, I.timecards, I.employees, I.trainingRecords],
        '/admin',
      ),
      section('help', 'Help', '❓',
        'Help', 'Documentation, support, and contact options.',
  ...
  compliance_manager: {
    ...
    sections: [
      ...
      section('administration', 'Administration', '⚙️',
        ...
        [I.settings, I.timecards, I.employees, I.trainingRecords],
        '/admin',
      ),
      section('help', 'Help', '❓',
        'Help', 'Documentation, support, and contact options.',
  ...
  owner_operator: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.deficiencies, I.documents, I.incidents, I.insuranceRisk, I.workforceRisk, I.cicPse, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.selfInspection, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
  ...
  executive: {
    ...
    sections: [
      ...
      section('administration', 'Administration', '⚙️',
        ...
        [I.integrations, I.settings, I.rolesPermissions, I.timecards, I.employees, I.trainingRecords],
        '/admin',
      ),
      section('help', 'Help', '❓',
        'Help', 'Documentation, support, and contact options.',
