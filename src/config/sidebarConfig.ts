  ...
  platform_admin: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.deficiencies, I.documents, I.inspectorArrival, I.insuranceRisk, I.workforceRisk, I.cicPse, I.progress, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.selfInspection, I.mockInspection, I.services, I.vendorDocReview, I.vendorMarketplace, I.vendorConnect],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
        ...
        [I.aiInsights, I.copilotInsights, I.analytics, I.complianceTrends, I.auditLog, I.benchmarks, I.intelligence, I.clientIntelligence, I.clientReports, I.predictions, I.iotDashboard],
        '/insights',
      ),
      section('tools', 'Tools', '🔧',
  ...
  kitchen_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.deficiencies, I.documents, I.incidents, I.regulatory, I.reporting, I.selfInspection, I.mockInspection, I.services, I.vendorDocReview, I.vendorMarketplace],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
        'Insights', 'Artificial Intelligence-powered analysis, analytics, compliance trends, and recommendations.',
        [I.aiInsights, I.copilotInsights, I.analytics, I.complianceTrends, I.predictions],
        '/insights',
      ),
      section('tools', 'Tools', '🔧',
        'Tools', 'Equipment troubleshooting and voice commands.',
  ...
  compliance_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.deficiencies, I.documents, I.incidentsViewOnly, I.inspectorArrival, I.insuranceRisk, I.workforceRisk, I.cicPse, I.progress, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.services, I.vendorDocReview, I.vendorMarketplace, I.vendorConnect],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
        'Insights', 'Artificial Intelligence-powered analysis — audit logs, compliance intelligence, and Internet of Things monitoring.',
        [I.aiInsights, I.copilotInsights, I.auditLog, I.intelligence, I.clientIntelligence, I.clientReports, I.predictions, I.iotDashboard],
        '/insights',
      ),
      section('tools', 'Tools', '🔧',
  ...
  owner_operator: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.deficiencies, I.documents, I.incidents, I.insuranceRisk, I.workforceRisk, I.cicPse, I.progress, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.selfInspection, I.mockInspection, I.services, I.vendorDocReview, I.vendorMarketplace, I.vendorConnect],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
  ...
  executive: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.correctiveActions, I.deficiencies, I.incidentsViewOnly, I.insuranceRisk, I.workforceRisk, I.cicPse, I.progress, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.services, I.vendorDocReview, I.vendorMarketplace, I.vendorConnect],
        '/compliance',
      ),
      section('tools', 'Tools', '🔧',
