  ...
  compliance_manager: {
    ...
    sections: [
      section('food-safety', 'Food Safety', '🍽️',
        ...
        [I.foodSafetyOverview, I.foodSafetyAnalysis, I.foodSafetyTrajectory, I.temperaturesViewOnly, I.checklists, I.incidents, I.correctiveActions, I.haccp, I.taskManager],
        '/food-safety',
      ),
      section('facility-safety', 'Fire Safety', '🔥',
        'Fire Safety', 'Fire safety compliance and fire inspection readiness.',
