  ...
  platform_admin: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.documents, I.inspectorArrival, I.insuranceRisk, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.selfInspection, I.services, I.vendorMarketplace],
        '/compliance',
      ),
  ...
  compliance_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.documents, I.incidentsViewOnly, I.inspectorArrival, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
  ...
  owner_operator: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.complianceOverview, I.documents, I.incidents, I.insuranceRisk, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.selfInspection, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
