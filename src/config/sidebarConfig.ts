...
const ROLE_CONFIGS: Record<UserRole, RoleSidebarConfig> = {
  ...
  platform_admin: {
    ...
    sections: [
      ...
      section('food-safety', 'Food Safety', '🍽️',
        ...
        [I.checklists, I.temperatures, I.haccp, I.correctiveActions, I.incidents],
        '/scoring-breakdown',
      ),
      ...
      section('compliance', 'Compliance', '📋',
        'Compliance', 'Documents, inspections, insurance risk, regulatory tracking, and more.',
        [I.documents, I.inspectorArrival, I.insuranceRisk, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.selfInspection, I.services],
      ),
  ...
  kitchen_staff: {
    ...
    sections: [
      ...
      section('tools', 'Tools', '🔧',
        'Tools', 'Kitchen checkup and equipment diagnosis.',
  ...
  chef: {
    ...
    sections: [
      section('calendar-section', 'Calendar', '📅',
        'Calendar', 'Inspections, deadlines, and service appointments.',
        [], '/calendar',
      ),
      section('food-safety', 'Food Safety', '🍽️',
        'Food Safety', 'Checklists, temperature logs, HACCP plans, corrective actions, and incidents.',
        [I.checklists, I.temperatures, I.haccp, I.correctiveActions, I.incidents],
        '/scoring-breakdown',
      ),
      section('facility-safety', 'Facility Safety', '🔥',
      ...
      section('compliance', 'Compliance', '📋',
        'Compliance', 'Food safety scoring overview.',
  ...
  compliance_manager: {
    ...
    sections: [
      ...
      section('food-safety', 'Food Safety', '🍽️',
        'Food Safety', 'Checklists, temperature monitoring, HACCP plans, corrective actions, and incidents.',
        [I.checklists, I.temperaturesViewOnly, I.haccp, I.correctiveActions, I.incidentsViewOnly],
        '/scoring-breakdown',
      ),
      section('facility-safety', 'Facility Safety', '🔥',
        'Facility Safety', 'Facility safety compliance and fire inspection readiness.',
      ...
      section('compliance', 'Compliance', '📋',
        'Compliance', 'Documentation, inspector view, jurisdiction intelligence, regulatory tracking, reporting, and services.',
        [I.documents, I.inspectorArrival, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.services],
      ),
      section('insights', 'Insights', '💡',
  ...
  facilities_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        'Compliance', 'Compliance reporting and documentation.',
        [I.reporting],
      ),
  ...
  owner_operator: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        'Compliance', 'Documents, insurance risk, regulatory tracking, reporting, self-inspection, and vendor services.',
        [I.documents, I.insuranceRisk, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.selfInspection, I.services],
      ),
      section('insights', 'Insights', '💡',
  ...
  executive: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        'Compliance', 'Incidents, insurance risk, Know Your Inspector, regulatory tracking, compliance reporting, and vendor services.',
        [I.incidentsViewOnly, I.insuranceRisk, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.services],
      ),
      section('tools', 'Tools', '🔧',
