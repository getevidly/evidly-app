  ...
  compliance_manager: {
    ...
    sections: [
      section('compliance', 'Compliance', '📋',
        ...
        [I.correctiveActions, I.documents, I.fireSafety, I.haccp, I.regulatory, I.reporting, I.selfInspection, I.services, I.vendorCertifications],
      ),
      section('insights', 'Insights', '💡',
        'Insights', 'AI-powered analysis — audit logs, intelligence dashboards, jurisdiction scoring, and violation trends.',
        [I.aiInsights, I.auditLog, I.businessIntelligence, I.iotDashboard, I.jurisdictionIntelligence, I.scoreTable, I.violationTrends],
      ),
      section('daily', 'Daily Operations', '✓',
  ...
  owner_operator: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.correctiveActions, I.documents, I.fireSafety, I.haccp, I.incidents, I.regulatory, I.selfInspection, I.services],
      ),
      section('insights', 'Insights', '💡',
  ...
  executive: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.fireSafety, I.haccp, I.regulatory, I.reporting, I.services],
      ),
      section('administration', 'Administration', '⚙️',
