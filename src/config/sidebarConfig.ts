...
const ROLE_CONFIGS: Record<UserRole, RoleSidebarConfig> = {
  ...
  platform_admin: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.documents, I.inspectorArrival, I.insuranceRisk, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.selfInspection, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
        'Insights', 'Artificial Intelligence advisor, analytics, audit logs, benchmarks, compliance intelligence, and Internet of Things.',
        [I.aiInsights, I.analytics, I.auditLog, I.benchmarks, I.intelligence, I.iotDashboard],
        '/insights',
      ),
  ...
  kitchen_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.documents, I.incidents, I.regulatory, I.reporting, I.selfInspection, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
  ...
  compliance_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.documents, I.incidentsViewOnly, I.inspectorArrival, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
        'Insights', 'Artificial Intelligence-powered analysis — audit logs, compliance intelligence, and Internet of Things monitoring.',
        [I.aiInsights, I.auditLog, I.intelligence, I.iotDashboard],
        '/insights',
      ),
      section('tools', 'Tools', '🔧',
  ...
  facilities_manager: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        'Compliance', 'Compliance reporting, documentation, and vendor marketplace.',
        [I.reporting, I.vendorMarketplace],
        '/compliance',
      ),
  ...
  owner_operator: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.documents, I.incidents, I.insuranceRisk, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.selfInspection, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('insights', 'Insights', '💡',
        'Insights', 'Artificial Intelligence-powered analysis, analytics, audit logs, benchmarks, compliance intelligence, and Internet of Things monitoring.',
        [I.aiInsights, I.analytics, I.auditLog, I.benchmarks, I.intelligence, I.iotDashboard],
        '/insights',
      ),
      section('tools', 'Tools', '🔧',
  ...
  executive: {
    ...
    sections: [
      ...
      section('compliance', 'Compliance', '📋',
        ...
        [I.incidentsViewOnly, I.insuranceRisk, I.jurisdictionIntelligence, I.regulatory, I.reporting, I.services, I.vendorMarketplace],
        '/compliance',
      ),
      section('tools', 'Tools', '🔧',
