...
const I: Record<string, NavItem> = {
  ...
  foodSafetyOverview: {
    id: 'food-safety-overview', label: 'Overview', path: '/food-safety', icon: '🍽️',
...
const ROLE_CONFIGS: Record<UserRole, RoleSidebarConfig> = {
  ...
  kitchen_staff: {
    ...
    sections: [
      section('food-safety', 'Food Safety', '🍽️',
        ...
        [I.foodSafetyAnalysis, I.foodSafetyTrajectory, I.temperatures, I.checklists, I.incidents, I.correctiveActions],
        '/food-safety',
      ),
      section('tools', 'Tools', '🔧',
  ...
  chef: {
    ...
    sections: [
      section('food-safety', 'Food Safety', '🍽️',
        ...
        [I.foodSafetyOverview, I.foodSafetyAnalysis, I.foodSafetyTrajectory, I.temperatures, I.checklists, I.incidents, I.correctiveActions, I.haccp, I.taskManager],
        '/food-safety',
      ),
      section('insights', 'Insights', '💡',
  ...
  kitchen_manager: {
    ...
    topLevelItems: [I.complianceOverview],
    sections: [
      section('food-safety', 'Food Safety', '🍽️',
        'Food Safety', 'Checklists, temperature logs, HACCP plans, corrective actions, and food safety overview.',
        [I.foodSafetyOverview, I.temperatures, I.checklists, I.incidents, I.correctiveActions, I.haccp, I.taskManager, I.foodSafetyAnalysis, I.foodSafetyTrajectory],
        '/food-safety',
      ),
      section('compliance', 'Compliance', '📋',
  ...
  compliance_manager: {
    ...
    sections: [
      section('food-safety', 'Food Safety', '🍽️',
        ...
        [I.foodSafetyOverview, I.temperaturesViewOnly, I.checklists, I.incidents, I.correctiveActions, I.haccp, I.taskManager, I.foodSafetyAnalysis, I.foodSafetyTrajectory],
        '/food-safety',
      ),
      section('facility-safety', 'Fire Safety', '🔥',
        'Fire Safety', 'Fire safety compliance and fire inspection readiness.',
        [I.calendar, I.fireSafetyAnalysis, I.fireSafetyTrajectory], '/facility-safety',
      ),
      section('compliance', 'Compliance', '📋',
  ...
  facilities_manager: {
    ...
    sections: [
      section('facility-safety', 'Fire Safety', '🔥',
        ...
        [I.calendar, I.fireSafetyAnalysis, I.fireSafetyTrajectory, I.incidents, I.correctiveActions, I.inspectorArrival], '/facility-safety',
      ),
      section('compliance', 'Compliance', '📋',
