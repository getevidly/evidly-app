...
async function calculateFireFactors(
  ...
  const factors: Factor[] = [
    ...
    { name: "Cleaning to bare metal verified", score: hoodScore >= 90 ? 100 : hoodScore >= 50 ? 70 : 30, weight: 0.10, status: factorStatus(hoodScore >= 90 ? 100 : hoodScore >= 50 ? 70 : 30), detail: hoodScore >= 90 ? "Bare metal cleaning documented" : "Cleaning verification incomplete", reference: "NFPA 96-2024 Table 12.4", category: "fire", improvement: "Request bare metal cleaning verification from vendor" },
