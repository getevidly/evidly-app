...
async function calculateFireFactors(
  ...
  const factors: Factor[] = [
    { name: "Hood cleaning current per NFPA 96-2025 schedule", score: hoodScore, weight: 0.18, status: factorStatus(hoodScore), detail: `Hood cleaning: ${vendorDetail("Hood Cleaning")}`, reference: "NFPA 96-2025", category: "fire", improvement: "Schedule hood cleaning service" },
    ...
    { name: "Cleaning to bare metal verified", score: hoodScore >= 90 ? 100 : hoodScore >= 50 ? 70 : 30, weight: 0.10, status: factorStatus(hoodScore >= 90 ? 100 : hoodScore >= 50 ? 70 : 30), detail: hoodScore >= 90 ? "Bare metal cleaning documented" : "Cleaning verification incomplete", reference: "NFPA 96-2025 §11.4", category: "fire", improvement: "Request bare metal cleaning verification from vendor" },
    { name: "Automatic fuel/electric shutoff tested", score: greaseScore, weight: 0.10, status: factorStatus(greaseScore), detail: greaseScore >= 80 ? "Shutoff systems tested" : "Shutoff testing overdue", reference: "NFPA 96-2025 §10.1", category: "fire", improvement: "Schedule shutoff system test" },
