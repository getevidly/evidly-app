...
</td></tr></table></td></tr><tr><td style="padding-top:8px"><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse"><tr><td bgcolor="#1E2D4D" style="background:#1E2D4D;padding:22px 28px">
   <table cellpadding="0" cellspacing="0" border="0"><tr><td bgcolor="#CB5C39" style="background:#CB5C39;border-radius:5px">
     <a href="https://calendly.com/founders-getevidly/discovery-call" style="display:inline-block;font-family:Arial,Helvetica,sans-serif;font-weight:bold;font-size:15px;color:#FFFFFF;text-decoration:none;padding:12px 24px">Schedule a meeting</a>
   </td></tr></table>
   <div style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#AEBACD;line-height:1.5;margin-top:14px">Bring this checklist. We will go through it with you &mdash; what you can produce today, what is missing, and what it takes to keep every record current.</div>
   <div style="margin-top:14px"><a href="tel:+18553843591" style="font-family:Arial,Helvetica,sans-serif;font-weight:bold;font-size:17px;color:#CB5C39;text-decoration:none">(855) 384-3591</a></div>
