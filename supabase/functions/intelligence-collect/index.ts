...
const INTELLIGENCE_SOURCES: IntelligenceSource[] = [
  ...
  // foodsafetygov_alerts REMOVED — duplicate of openfda_enforcement (same underlying data)
  ...
  { id: "cal_osha_citations", name: "Cal/OSHA Food Service Citations", url: "https://www.dir.ca.gov/dosh/Citation-statistics.html",
  ...
  { id: "abc_license_actions", name: "ABC License Actions Affecting Food Service",
    url: "https://www.abc.ca.gov/news-releases/",
    type: "web_page", category: "enforcement_surge", defaultSeverity: "medium", defaultScope: "regional", pillar: ["food_safety"],
  ...
  { id: "usda_commodity", name: "USDA Commodity Price Alerts", url: "https://www.ams.usda.gov/market-news",
  ...
  { id: "ca_drought", name: "California Drought & Water Restriction Updates", url: "https://www.water.ca.gov/Water-Basics/Drought",
  ...
  { id: "nra_safety", name: "National Restaurant Association Safety & Compliance",
    url: "https://restaurant.org/research-and-media/media/press-releases/",
    type: "web_page", category: "regulatory_change", defaultSeverity: "low", defaultScope: "national", pillar: ["food_safety"],
  ...
  { id: "ca_oal_food", name: "California Office of Administrative Law — Food Safety Regulations", url: "https://oal.ca.gov/publications/rulemaking_calendar",
