...
--   Port of Long Beach; CSULB campus; Convention Center events
-- ============================================================
...
UPDATE jurisdictions SET
  ...
  grading_config = '{
    ...
    "county_context": "Independent city (~3,000–4,000 facilities). NOT under LA County EHD — separate jurisdiction, separate permits. Port of Long Beach; CSULB campus; Long Beach Convention Center. Dog-friendly patio dining policy (City Council approved July 2012).",
  ...
  local_amendment_notes = 'Independent city health dept. LA County permits NOT valid within Long Beach. Score Card posted for scores below 70. Dog-friendly patio policy (July 2012).',
