...
-- ── Part 13: Auto clock-out columns on time_entries ──────────
...
-- ── Part 13: Clock reminder settings on vendor_settings ──────
...
-- ── Part 14: Meeting location columns on scheduled_jobs ──────
...
CREATE TABLE IF NOT EXISTS timecard_alterations (
  ...
  altered_by UUID REFERENCES employees(id) ON DELETE SET NULL,
