-- Migration: drop_external_tables
-- Status: APPLIED — placeholder file
-- Original timestamp: 20260321200000
--
...
--
-- Tracker entry: supabase_migrations.schema_migrations WHERE version = '20260321200000'.
--
-- ── ORIGINAL DDL ─────────────────────────────────────────────────────────
-- Original file content was not recoverable from git history.
-- Migration name suggests: Dropping external/foreign tables no longer needed in PROD.
