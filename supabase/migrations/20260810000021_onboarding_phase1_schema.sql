...
CREATE TABLE IF NOT EXISTS onboarding_pillar_requirements (
  ...
  description TEXT,
  citation TEXT,
  action_type TEXT NOT NULL CHECK (action_type IN ('upload', 'route_out', 'confirm', 'invite')),
...
('CA', 'food_safety', 'health_permit', 'Health Permit', 'Valid health permit issued by local EHD, posted in public view', 'CalCode 114381', 'upload', 'owner_operator', 1),
('CA', 'food_safety', 'food_manager_cert', 'Food Manager Certification', 'At least one certified food safety manager per facility (ServSafe, NRFSP, or equivalent)', 'CalCode 113947.1', 'upload', 'compliance_manager', 2),
...
('CA', 'food_safety', 'haccp_plan', 'HACCP Plan', 'Written HACCP plan required for facilities with specialized processes', 'CalCode 114419', 'route_out', 'compliance_manager', 4),
('CA', 'food_safety', 'temperature_logs', 'Temperature Monitoring', 'Time/temperature control for safety foods — continuous monitoring required', 'CalCode 114000', 'route_out', 'chef', 5),
...
('CA', 'fire_safety', 'fire_extinguishers', 'Fire Extinguisher Service', 'Portable fire extinguishers inspected monthly, serviced annually', 'NFPA 10', 'upload', 'facilities_manager', 3),
('CA', 'fire_safety', 'fire_alarm', 'Fire Alarm Monitoring', 'Fire alarm system inspected and tested per NFPA 72 schedule', 'NFPA 72', 'upload', 'facilities_manager', 4),
('CA', 'fire_safety', 'sprinkler_system', 'Sprinkler Inspection', 'Automatic sprinkler system inspected quarterly, tested annually', 'NFPA 25', 'upload', 'facilities_manager', 5),
