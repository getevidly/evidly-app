...
-- NOTE: HACCP ALTER TABLE statements (haccp_plans, haccp_critical_control_points,
-- haccp_monitoring_logs) moved to 20260328100000_daily_checklists_haccp_columns.sql
-- to run after 20260328000003_haccp_tables.sql creates the base tables.
...
-- NOTE: HACCP auto-populate trigger moved to 20260328100000_daily_checklists_haccp_columns.sql

-- ═══════════════════════════════════════════════════════════════════════
-- PART 3: SEED DEFAULT CHECKLIST TEMPLATES
...
BEGIN
  ...
  (t_opening_food, 'Walk-in cooler temperature', 'Walk-in cooler temperature ≤41°F', 'temperature', 'food_safety', 'temperature', 'calcode', '§113996(a)', 'Cold holding at 41°F or below', false, 'CCP-02', 'Biological — pathogen growth', '≤41°F', false, false, 41, 5, 5),
  (t_opening_food, 'Walk-in freezer temperature', 'Walk-in freezer temperature ≤0°F', 'temperature', 'food_safety', 'temperature', 'calcode', '§113996(a)', 'Frozen food storage at 0°F or below', false, 'CCP-02', 'Biological — pathogen growth', '≤0°F', false, false, 0, 6, 6),
  (t_opening_food, 'Reach-in cooler temperatures', 'Reach-in cooler temperatures ≤41°F', 'temperature', 'food_safety', 'temperature', 'calcode', '§113996(a)', 'All reach-in units at proper cold holding temp', false, 'CCP-02', 'Biological — pathogen growth', '≤41°F', false, false, 41, 7, 7),
  ...
  (t_receiving, 'Poultry received ≤41°F', 'Poultry — received at ≤41°F', 'temperature', 'food_safety', 'temperature', 'calcode', '§113980', 'Poultry must be received at 41°F or below', false, 'CCP-01', 'Biological', '≤41°F', 41, true, 3, 3),
  (t_receiving, 'Ground meat received ≤41°F', 'Ground meat — received at ≤41°F', 'temperature', 'food_safety', 'temperature', 'calcode', '§113980', 'Ground meat must be received at 41°F or below', false, 'CCP-01', 'Biological', '≤41°F', 41, true, 4, 4),
  (t_receiving, 'Seafood received ≤41°F', 'Seafood — received at ≤41°F', 'temperature', 'food_safety', 'temperature', 'calcode', '§113980', 'Seafood must be received at 41°F or below', false, 'CCP-01', 'Biological', '≤41°F', 41, true, 5, 5),
  (t_receiving, 'Dairy received ≤41°F', 'Dairy — received at ≤41°F', 'temperature', 'food_safety', 'temperature', 'calcode', '§113980', 'Dairy must be received at 41°F or below', false, 'CCP-01', 'Biological', '≤41°F', 41, true, 6, 6),
  ...
  (t_mid_shift, 'Hot holding ≥135°F', 'Hot holding — all items ≥135°F', 'temperature', 'food_safety', 'temperature', 'calcode', '§113996(a)', 'Hot held TCS food must be at 135°F or above', 'CCP-04', 'Biological — pathogen growth', '≥135°F', 135, NULL, 1, 1),
  (t_mid_shift, 'Cold holding ≤41°F', 'Cold holding — all items ≤41°F', 'temperature', 'food_safety', 'temperature', 'calcode', '§113996(a)', 'Cold held TCS food must be at 41°F or below', 'CCP-03', 'Biological — pathogen growth', '≤41°F', NULL, 41, 2, 2),
  (t_mid_shift, 'Walk-in cooler temperature', 'Walk-in cooler temperature', 'temperature', 'food_safety', 'temperature', 'calcode', '§113996(a)', 'Walk-in cooler at proper holding temp', 'CCP-02', 'Biological — pathogen growth', '≤41°F', NULL, 41, 3, 3),
  ...
  (t_mid_shift, 'Active cooling on track', 'Active cooling — items in cooling process on track (135→70 in 2hrs, 70→41 in 4hrs)', 'yes_no', 'food_safety', 'temperature', 'calcode', '§114002', 'Two-stage cooling: 135→70°F in 2hrs, 70→41°F within next 4hrs', 'CCP-05', 'Biological — pathogen growth', '135→70 in 2hrs, 70→41 in 4hrs', NULL, NULL, 5, 5),
  ...
  (t_closing, 'Walk-in cooler final temp', 'Walk-in cooler final temperature ≤41°F', 'temperature', 'food_safety', 'temperature', 'calcode', '§113996(a)', 'Verify cooler holding temp before closing', false, 'CCP-02', '≤41°F', 41, false, 1, 1),
  ...
  (t_closing, 'Cooling items completed', 'All cooling items completed to ≤41°F', 'yes_no', 'food_safety', 'temperature', 'calcode', '§114002', 'All items in cooling process must reach 41°F', true, 'CCP-05', '≤41°F', NULL, true, 3, 3),
