...
--   Sacramento:    Green / Yellow / Red placard only (no numeric score published)
...
UPDATE jurisdictions SET
  ...
  local_amendment_notes = 'No local amendments to CalCode grading. Green / Yellow / Red placard program is a county-level overlay on standard CalCode enforcement.',
  ...
  notes = 'STANDARDIZED March 2026 (updated). DUAL: Green / Yellow / Red placard + numeric score — both published. HIGH transparency. Silicon Valley (San Jose = 10th largest US city). Program launched Oct 2014, modeled on Sacramento Green / Yellow / Red. SCCDineOut portal + mobile app. Placard color determined by numeric score thresholds (Green=90+, Yellow=70-89, Red=<70).'
