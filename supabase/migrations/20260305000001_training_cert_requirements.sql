...
DROP POLICY IF EXISTS "Users can view their org requirements" ON certification_requirements;
...
DROP POLICY IF EXISTS "Admins can manage their org requirements" ON certification_requirements;
...
DROP POLICY IF EXISTS "Users can view their org training records" ON training_records;
...
DROP POLICY IF EXISTS "Managers can manage training records" ON training_records;
