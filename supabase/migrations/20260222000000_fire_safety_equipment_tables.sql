...
CREATE INDEX IF NOT EXISTS idx_equipment_location ON equipment(organization_id, location_id);
CREATE INDEX IF NOT EXISTS idx_equipment_type ON equipment(equipment_type);
CREATE INDEX IF NOT EXISTS idx_equipment_maintenance ON equipment(next_maintenance_due) WHERE is_active = true;
...
CREATE INDEX IF NOT EXISTS idx_equipment_schedule_equipment ON equipment_maintenance_schedule(equipment_id);
CREATE INDEX IF NOT EXISTS idx_equipment_schedule_due ON equipment_maintenance_schedule(next_due) WHERE next_due IS NOT NULL;
ALTER TABLE equipment_maintenance_schedule ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "Users can view schedule via equipment org" ON equipment_maintenance_schedule;
...
DROP POLICY IF EXISTS "Users can insert schedule via equipment org" ON equipment_maintenance_schedule;
...
DROP POLICY IF EXISTS "Users can update schedule via equipment org" ON equipment_maintenance_schedule;
...
DROP POLICY IF EXISTS "Service role full access schedule" ON equipment_maintenance_schedule;
...
DROP TRIGGER IF EXISTS equipment_schedule_updated_at ON equipment_maintenance_schedule;
