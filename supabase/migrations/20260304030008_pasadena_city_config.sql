...
UPDATE jurisdictions SET
  ...
  grading_config = '{
    ...
    "county_context": "Independent city (~1,500–2,000 facilities). Old Town Pasadena high-density restaurant district. Rose Bowl (major events, concerts, swap meet). Pasadena City College and Cal Tech campus food service. Closed alternating Fridays. Permit Suspension Hearing fee: $150.",
