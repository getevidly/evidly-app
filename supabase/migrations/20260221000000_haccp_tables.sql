...
CREATE INDEX idx_haccp_plans_org ON haccp_plans(organization_id);
...
CREATE INDEX idx_haccp_ccps_plan ON haccp_critical_control_points(plan_id);
CREATE INDEX idx_haccp_ccps_location ON haccp_critical_control_points(location_id);
...
CREATE INDEX idx_haccp_monitoring_ccp ON haccp_monitoring_logs(ccp_id, monitored_at DESC);
CREATE INDEX idx_haccp_monitoring_org ON haccp_monitoring_logs(organization_id);
...
CREATE INDEX idx_haccp_ca_org ON haccp_corrective_actions(organization_id);
CREATE INDEX idx_haccp_ca_status ON haccp_corrective_actions(organization_id, status);
CREATE INDEX idx_haccp_ca_location ON haccp_corrective_actions(location_id);
